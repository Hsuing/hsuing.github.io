import{_ as e,D as a,o as n,c as p,I as l,w as t,R as o,a as c}from"./chunks/framework.PZ77rLUR.js";const b=JSON.parse('{"title":"1.关闭 A服务器 上 的 geth","description":"","frontmatter":{},"headers":[],"relativePath":"guide/Blockchain/geth/4-geth同步区块.md","filePath":"guide/Blockchain/geth/4-geth同步区块.md","lastUpdated":1701401252000}'),i={name:"guide/Blockchain/geth/4-geth同步区块.md"},r=o(`<p>核心思路 : 从原有的(或者从别人那里) 拷贝数据到自己的服务器</p><blockquote><p>在 geth 的控制台调用 eth.syncing 发现 currentBlock 一直低于highestBlock</p></blockquote><p>环境：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">服务器 A: 已经同步好区块的服务器</span></span>
