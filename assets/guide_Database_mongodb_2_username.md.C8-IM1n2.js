import{_ as s,c as e,o as a,R as n}from"./chunks/framework.CIzs38F0.js";const b=JSON.parse('{"title":"1.开启认证","description":"","frontmatter":{},"headers":[],"relativePath":"guide/Database/mongodb/2_username.md","filePath":"guide/Database/mongodb/2_username.md","lastUpdated":1704853811000}'),l={name:"guide/Database/mongodb/2_username.md"},t=n(`<ul><li>mongo5.0.5</li></ul><p>用户是跟着库创建的，在哪个库创建的什么权限的什么用户，只对此库有相应权限（除超级管理员以外）</p><h1 id="_1-开启认证" tabindex="-1">1.开启认证 <a class="header-anchor" href="#_1-开启认证" aria-label="Permalink to &quot;1.开启认证&quot;">​</a></h1><h2 id="配置认证文件" tabindex="-1">配置认证文件 <a class="header-anchor" href="#配置认证文件" aria-label="Permalink to &quot;配置认证文件&quot;">​</a></h2><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">vi /etc/mongod.conf</span></span></code></pre><pre class="shiki github-light vp-code-light"><code><span class="line"><span style="color:#24292e;">vi /etc/mongod.conf</span></span></code></pre></div><ul><li>开启认证</li></ul><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">security:</span></span>
...
<span class="line"><span style="color:#24292e;">}</span></span>
<span class="line"><span style="color:#24292e;">)</span></span></code></pre></div>`,86),o=[t];function p(r,c,i,d,u,y){return a(),e("div",null,o)}const h=s(l,[["render",p]]);export{b as __pageData,h as default};
