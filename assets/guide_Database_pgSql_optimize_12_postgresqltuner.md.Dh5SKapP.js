import{_ as s,c as e,o as n,R as a}from"./chunks/framework.CIzs38F0.js";const _=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"guide/Database/pgSql/optimize/12_postgresqltuner.md","filePath":"guide/Database/pgSql/optimize/12_postgresqltuner.md","lastUpdated":1703063387000}'),p={name:"guide/Database/pgSql/optimize/12_postgresqltuner.md"},l=a(`<div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">#该工具基于Perl语言开发,首先安装Perl相关的开发包</span></span>
