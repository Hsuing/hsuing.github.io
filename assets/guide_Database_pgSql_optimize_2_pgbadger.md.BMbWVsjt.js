...
<span class="line"><span style="color:#24292e;">%u:表示用户名</span></span></code></pre></div><ul><li>Examples:</li></ul><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;"></span></span>
...
<span class="line"><span style="color:#24292e;">fi</span></span></code></pre></div>`,29),o=[p];function t(r,c,i,d,g,y){return e(),a("div",null,o)}const b=s(l,[["render",t]]);export{u as __pageData,b as default};
