import{_ as s,c as n,o as a,R as e}from"./chunks/framework.CIzs38F0.js";const _=JSON.parse('{"title":"nginx 配置文件","description":"","frontmatter":{},"headers":[],"relativePath":"guide/Linux/web/nginx/7-location和try作用.md","filePath":"guide/Linux/web/nginx/7-location和try作用.md","lastUpdated":1701684699000}'),l={name:"guide/Linux/web/nginx/7-location和try作用.md"},p=e(`<h1 id="nginx-配置文件" tabindex="-1">nginx 配置文件 <a class="header-anchor" href="#nginx-配置文件" aria-label="Permalink to &quot;nginx 配置文件&quot;">​</a></h1><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">server {</span></span>
