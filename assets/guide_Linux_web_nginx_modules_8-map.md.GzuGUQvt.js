import{_ as s,o as n,c as a,R as e}from"./chunks/framework.byfcZK4E.js";const u=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"guide/Linux/web/nginx/modules/8-map.md","filePath":"guide/Linux/web/nginx/modules/8-map.md","lastUpdated":1701684699000}'),l={name:"guide/Linux/web/nginx/modules/8-map.md"},p=e(`<ul><li>map</li></ul><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">map $http_host $name {</span></span>
