import{_ as s,o as n,c as e,R as a}from"./chunks/framework.PZ77rLUR.js";const h=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"guide/Linux/web/nginx/proxy/index.md","filePath":"guide/Linux/web/nginx/proxy/index.md","lastUpdated":1701684699000}'),p={name:"guide/Linux/web/nginx/proxy/index.md"},l=a(`<p>sawk &#39;{if($NF==&quot;HIT&quot;) hit++} END {printf &quot;%.2f%\\n&quot;,hit/NR*100 }&#39; access.log</p><ul><li>proxy 优化</li></ul><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">//nignx会把后端返回的内容先放到缓冲区当中，然后再返回给客户端,边收边传, 不是全部接收完再传给客户端</span></span>
