import{_ as s,o as e,c as n,R as a}from"./chunks/framework.zUbWieqp.js";const u=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"guide/Shells/index.md","filePath":"guide/Shells/index.md","lastUpdated":1729765555000}'),l={name:"guide/Shells/index.md"},p=a(`<div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;"># 执行命令遇到错误就退出</span></span>
...
<span class="line"><span style="color:#24292e;">set -o pipefail</span></span></code></pre></div>`,1),o=[p];function t(c,i,r,d,_,y){return e(),n("div",null,o)}const g=s(l,[["render",t]]);export{u as __pageData,g as default};
