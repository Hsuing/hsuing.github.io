import{_ as s,c as n,o as a,R as l}from"./chunks/framework.CIzs38F0.js";const u=JSON.parse('{"title":"1.golang继承","description":"","frontmatter":{},"headers":[],"relativePath":"guide/go/28-Go继承.md","filePath":"guide/go/28-Go继承.md","lastUpdated":1701229860000}'),p={name:"guide/go/28-Go继承.md"},o=l(`<h1 id="_1-golang继承" tabindex="-1">1.golang继承 <a class="header-anchor" href="#_1-golang继承" aria-label="Permalink to &quot;1.golang继承&quot;">​</a></h1><p>golang本质上没有oop(<strong>Object Orientation Programming</strong>)的概念，也没有继承的概念，但是可以通过结构体嵌套实现这个特性。</p><div class="language-go vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">go</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#F97583;">package</span><span style="color:#E1E4E8;"> </span><span style="color:#B392F0;">main</span></span>
...
<span class="line"><span style="color:#24292E;">}</span></span></code></pre></div>`,5),t=[o];function e(c,r,E,y,i,F){return a(),n("div",null,t)}const m=s(p,[["render",e]]);export{u as __pageData,m as default};
