import{_ as s,o as n,c as a,R as e}from"./chunks/framework.PZ77rLUR.js";const g=JSON.parse('{"title":"获取中间件证书","description":"","frontmatter":{},"headers":[],"relativePath":"guide/Linux/web/nginx/ssl证书/5-ssl优化.md","filePath":"guide/Linux/web/nginx/ssl证书/5-ssl优化.md","lastUpdated":1701684699000}'),l={name:"guide/Linux/web/nginx/ssl证书/5-ssl优化.md"},p=e(`<div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">ssl_session_tickets       on;</span></span>
