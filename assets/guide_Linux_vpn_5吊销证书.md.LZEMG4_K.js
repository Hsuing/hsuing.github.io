import{_ as s,o as n,c as e,R as a}from"./chunks/framework.byfcZK4E.js";const g=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"guide/Linux/vpn/5吊销证书.md","filePath":"guide/Linux/vpn/5吊销证书.md","lastUpdated":1701595065000}'),p={name:"guide/Linux/vpn/5吊销证书.md"},l=a(`<div class="danger custom-block"><p class="custom-block-title">❌ 注意</p><p>吊销证书</p></div><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">[root@openvpn ~]# cd /etc/openvpn/easy-rsa/</span></span>
