...
<span class="line"><span style="color:#24292e;">UserParameter=queues.check[*],/bin/bash /usr/local/zabbix/queues_check.sh $1</span></span></code></pre></div><h2 id="_4、zabbix-server配置" tabindex="-1">4、zabbix_server配置 <a class="header-anchor" href="#_4、zabbix-server配置" aria-label="Permalink to &quot;4、zabbix_server配置&quot;">​</a></h2><p>以下均是图形配置</p><p>（1）、‘配置’---》‘模块’----》‘创建模板’，如下图：</p><p><img src="`+l+'" alt=""></p><p>（2）、‘模板’对话框如下图：</p><p>​ 模板名：RabbitMQ-Queues</p><p>​ 群组：jzkj</p><p><img src="'+t+'" alt=""></p><p>（3）、创建应用集，如下图：</p><p><img src="'+o+'" alt=""></p><p><img src="'+i+'" alt=""></p><p><img src="'+c+'" alt=""></p><p>（4）、设置‘自动发现规则’，如下图：</p><p><img src="'+r+'" alt=""></p><p><img src="'+b+'" alt=""></p><p><img src="'+u+'" alt=""></p><p>（5）、设置‘监控项原型’，如下图：</p><p><img src="'+q+'" alt=""></p><p><img src="'+m+'" alt=""></p><p><img src="'+h+'" alt=""></p><p>（6）、设置‘触发器类型’，如下图：</p><p><img src="'+y+'" alt=""></p><p><img src="'+g+'" alt=""></p><p><img src="'+d+'" alt=""></p><p><img src="'+_+'" alt=""></p><p><img src="'+x+'" alt=""></p>',47),f=[v];function k($,w,P,C,E,R){return n(),a("div",null,f)}const Q=s(z,[["render",k]]);export{D as __pageData,Q as default};
