...
<span class="line"><span style="color:#24292e;"></span></span>
<span class="line"><span style="color:#24292e;">          description: &quot;{{ $labels.queue }} MQ队列ready消息数&gt; 5000 持续10min (当前值: {{ $value }})&quot;</span></span></code></pre></div>`,28),t=[o];function r(c,i,u,y,q,b){return a(),n("div",null,t)}const _=s(l,[["render",r]]);export{d as __pageData,_ as default};
