import{_ as s,o as e,c as n,R as a}from"./chunks/framework.PZ77rLUR.js";const u=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"guide/Linux/web/nginx/modules/5-log.md","filePath":"guide/Linux/web/nginx/modules/5-log.md","lastUpdated":1701684699000}'),l={name:"guide/Linux/web/nginx/modules/5-log.md"},p=a(`<h2 id="_1-修改时间格式" tabindex="-1">1.修改时间格式 <a class="header-anchor" href="#_1-修改时间格式" aria-label="Permalink to &quot;1.修改时间格式&quot;">​</a></h2><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">$time_iso8601    生成格式：2019-04-20T09:24:35+08:00</span></span>
