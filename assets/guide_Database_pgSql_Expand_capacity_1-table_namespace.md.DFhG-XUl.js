...
<span class="line"><span style="color:#6A737D;">-- 24692是自定义表空间my_tablespace的oid</span></span>
<span class="line"><span style="color:#6A737D;">-- 13593是postgres数据库的oid</span></span>
<span class="line"><span style="color:#6A737D;">-- 24700是t2表的oid</span></span></code></pre></div>`,6),e=[o];function t(c,r,y,E,i,F){return n(),a("div",null,e)}const _=s(l,[["render",t]]);export{D as __pageData,_ as default};
