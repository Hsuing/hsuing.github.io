import{_ as s,o as n,c as a,R as p}from"./chunks/framework.byfcZK4E.js";const C=JSON.parse('{"title":"1.golang接口","description":"","frontmatter":{},"headers":[],"relativePath":"guide/go/27-Go接口.md","filePath":"guide/go/27-Go接口.md","lastUpdated":1701229860000}'),l={name:"guide/go/27-Go接口.md"},o=p(`<h1 id="_1-golang接口" tabindex="-1">1.golang接口 <a class="header-anchor" href="#_1-golang接口" aria-label="Permalink to &quot;1.golang接口&quot;">​</a></h1><p>接口像是一个公司里面的领导，他会定义一些通用规范，只设计规范，而不实现规范</p><p>go语言的接口，是一种新的<code>类型定义</code>,它把所有的<code>具有共性的方法</code>定义在一起，任何其他类型只要实现了这些方法就是实现了这个接口</p><p>语法格式和方法非常类似</p><h2 id="_1-1接口的语法格式" tabindex="-1">1.1接口的语法格式 <a class="header-anchor" href="#_1-1接口的语法格式" aria-label="Permalink to &quot;1.1接口的语法格式&quot;">​</a></h2><div class="language-go vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">go</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#6A737D;">/* 定义接口*/</span></span>
...
<span class="line"></span>
<span class="line"><span style="color:#F97583;">type</span><span style="color:#E1E4E8;"> </span><span style="color:#B392F0;">USB</span><span style="color:#E1E4E8;"> </span><span style="color:#F97583;">interface</span><span style="color:#E1E4E8;"> {</span></span>
...
<span class="line"></span>
<span class="line"><span style="color:#D73A49;">type</span><span style="color:#24292E;"> </span><span style="color:#6F42C1;">USB</span><span style="color:#24292E;"> </span><span style="color:#D73A49;">interface</span><span style="color:#24292E;"> {</span></span>
...
<span class="line"><span style="color:#24292E;">c.name: Lenvo</span></span>
<span class="line"><span style="color:#24292E;">write</span><span style="color:#D73A49;">...</span></span></code></pre></div><blockquote><p>实现接口必须实现接口中的所有方法</p></blockquote><h2 id="_1-2值类型接收者和指针类型接收者" tabindex="-1">1.2值类型接收者和指针类型接收者 <a class="header-anchor" href="#_1-2值类型接收者和指针类型接收者" aria-label="Permalink to &quot;1.2值类型接收者和指针类型接收者&quot;">​</a></h2><p>本质上和方法的值类型和指针类型接收者是一样的，值接收者是一个拷贝，是一个副本，而指针接收者，传递的是指针。</p><div class="language-go vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">go</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#F97583;">package</span><span style="color:#E1E4E8;"> </span><span style="color:#B392F0;">main</span></span>
<span class="line"></span>
<span class="line"><span style="color:#F97583;">import</span><span style="color:#E1E4E8;"> </span><span style="color:#9ECBFF;">&quot;</span><span style="color:#B392F0;">fmt</span><span style="color:#9ECBFF;">&quot;</span></span>
<span class="line"></span>
...
<span class="line"><span style="color:#24292E;">	pet.</span><span style="color:#005CC5;">eat</span><span style="color:#24292E;">()    </span></span>
<span class="line"><span style="color:#24292E;">}</span></span></code></pre></div><p><a href="https://www.bilibili.com/video/BV1zR4y1t7Wj?p=60&amp;spm_id_from=pageDriver&amp;vd_source=271cfb4bb43eae8c9b0543f4ae14ec31" target="_blank" rel="noreferrer">https://www.bilibili.com/video/BV1zR4y1t7Wj?p=60&amp;spm_id_from=pageDriver&amp;vd_source=271cfb4bb43eae8c9b0543f4ae14ec31</a></p><h2 id="_1-4接口嵌套" tabindex="-1">1.4接口嵌套 <a class="header-anchor" href="#_1-4接口嵌套" aria-label="Permalink to &quot;1.4接口嵌套&quot;">​</a></h2><p>接口可以通过嵌套，创建新的接口。</p><div class="language-go vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">go</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#F97583;">package</span><span style="color:#E1E4E8;"> </span><span style="color:#B392F0;">main</span></span>
<span class="line"></span>
<span class="line"><span style="color:#F97583;">import</span><span style="color:#E1E4E8;"> </span><span style="color:#9ECBFF;">&quot;</span><span style="color:#B392F0;">fmt</span><span style="color:#9ECBFF;">&quot;</span></span>
<span class="line"></span>
...
<span class="line"><span style="color:#24292E;">}</span></span></code></pre></div>`,32),e=[o];function t(c,r,E,y,i,F){return n(),a("div",null,e)}const m=s(l,[["render",t]]);export{C as __pageData,m as default};
