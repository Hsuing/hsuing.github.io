import{_ as s,c as n,o as a,R as p}from"./chunks/framework.CIzs38F0.js";const _=JSON.parse('{"title":"1.修改limit","description":"","frontmatter":{},"headers":[],"relativePath":"guide/Shells/scripts/aws/youhua.md","filePath":"guide/Shells/scripts/aws/youhua.md","lastUpdated":1702634445000}'),l={name:"guide/Shells/scripts/aws/youhua.md"},e=p(`<h1 id="_1-修改limit" tabindex="-1">1.修改limit <a class="header-anchor" href="#_1-修改limit" aria-label="Permalink to &quot;1.修改limit&quot;">​</a></h1><div class="language-bash vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#B392F0;">cat</span><span style="color:#E1E4E8;"> </span><span style="color:#F97583;">&gt;</span><span style="color:#E1E4E8;"> </span><span style="color:#9ECBFF;">/etc/security/limits.d/99-centos.conf</span><span style="color:#E1E4E8;"> </span><span style="color:#F97583;">&lt;&lt;</span><span style="color:#9ECBFF;">EOF</span></span>
...
<span class="line"><span style="color:#032F62;">EOF</span></span></code></pre></div>`,14),o=[e];function t(c,r,i,F,y,E){return a(),n("div",null,o)}const d=s(l,[["render",t]]);export{_ as __pageData,d as default};
