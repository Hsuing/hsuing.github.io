import{_ as s,c as n,o as a,R as e}from"./chunks/framework.CIzs38F0.js";const u=JSON.parse('{"title":"1.部署环境准备","description":"","frontmatter":{},"headers":[],"relativePath":"guide/container/swarm/1.install.md","filePath":"guide/container/swarm/1.install.md","lastUpdated":1711706974000}'),l={name:"guide/container/swarm/1.install.md"},p=e(`<h1 id="_1-部署环境准备" tabindex="-1">1.部署环境准备 <a class="header-anchor" href="#_1-部署环境准备" aria-label="Permalink to &quot;1.部署环境准备&quot;">​</a></h1><p><code>swarm 至少需要三个节点 所以需要准备三台机器</code></p><ul><li>练习环境</li></ul><p><a href="https://labs.play-with-docker.com/" target="_blank" rel="noreferrer">https://labs.play-with-docker.com/</a></p><div class="language-bash vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#6A737D;">#修改主机名</span></span>
