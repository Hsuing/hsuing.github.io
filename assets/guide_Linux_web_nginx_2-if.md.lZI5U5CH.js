import{_ as s,o as n,c as a,R as e}from"./chunks/framework.PZ77rLUR.js";const _=JSON.parse('{"title":"2,if中的几种判断条件","description":"","frontmatter":{},"headers":[],"relativePath":"guide/Linux/web/nginx/2-if.md","filePath":"guide/Linux/web/nginx/2-if.md","lastUpdated":1701684699000}'),p={name:"guide/Linux/web/nginx/2-if.md"},l=e(`<p>#1,屏蔽method</p><ul><li>在server 、location 中</li></ul><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">if ($request_method !~ ^(GET|HEAD)$ ) {</span></span>
...
<span class="line"><span style="color:#24292e;">        return 302 $scheme://$host/405.html;</span></span>
<span class="line"><span style="color:#24292e;">    }</span></span></code></pre></div>`,26),o=[l];function t(c,i,r,y,d,u){return n(),a("div",null,o)}const $=s(p,[["render",t]]);export{_ as __pageData,$ as default};
