import{_ as s,o as n,c as a,R as l}from"./chunks/framework.PZ77rLUR.js";const _=JSON.parse('{"title":"一、安装","description":"","frontmatter":{},"headers":[],"relativePath":"guide/Linux/web/nginx/10-geoip2.md","filePath":"guide/Linux/web/nginx/10-geoip2.md","lastUpdated":1701684699000}'),p={name:"guide/Linux/web/nginx/10-geoip2.md"},e=l(`<h1 id="一、安装" tabindex="-1">一、安装 <a class="header-anchor" href="#一、安装" aria-label="Permalink to &quot;一、安装&quot;">​</a></h1><ul><li>参考</li></ul><p><a href="https://www.maxmind.com/en/geoip2-databases" target="_blank" rel="noreferrer">https://www.maxmind.com/en/geoip2-databases</a></p><p><a href="https://docs.nginx.com/nginx/admin-guide/dynamic-modules/geoip2/" target="_blank" rel="noreferrer">https://docs.nginx.com/nginx/admin-guide/dynamic-modules/geoip2/</a></p><p><a href="https://www.fengbohello.top/archives/ip2location-geolite2" target="_blank" rel="noreferrer">https://www.fengbohello.top/archives/ip2location-geolite2</a></p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">#!/bin/bash</span></span>
