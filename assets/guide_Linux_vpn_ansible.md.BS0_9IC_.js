import{_ as s,c as a,o as e,R as n}from"./chunks/framework.CIzs38F0.js";const g=JSON.parse('{"title":"Playbooks","description":"","frontmatter":{},"headers":[],"relativePath":"guide/Linux/vpn/ansible.md","filePath":"guide/Linux/vpn/ansible.md","lastUpdated":1701595065000}'),l={name:"guide/Linux/vpn/ansible.md"},p=n(`<h2 id="如何使用ansible-freeipa" tabindex="-1">如何使用ansible-freeipa <a class="header-anchor" href="#如何使用ansible-freeipa" aria-label="Permalink to &quot;如何使用ansible-freeipa&quot;">​</a></h2><p><strong>GIT repo</strong></p><p>目前最简单的方法是直接从github克隆控制器上的这个存储库，并从ansible-freeipa目录开始部署：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">git clone https://github.com/freeipa/ansible-freeipa.git</span></span>
