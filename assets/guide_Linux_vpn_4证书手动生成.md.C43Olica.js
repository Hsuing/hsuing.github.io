import{_ as s,c as e,o as a,R as n}from"./chunks/framework.CIzs38F0.js";const v=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"guide/Linux/vpn/4证书手动生成.md","filePath":"guide/Linux/vpn/4证书手动生成.md","lastUpdated":1701595065000}'),l={name:"guide/Linux/vpn/4证书手动生成.md"},p=n(`<p>#一、安装</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">[root@localhost ~]# yum -y install openvpn easy-rsa</span></span></code></pre><pre class="shiki github-light vp-code-light"><code><span class="line"><span style="color:#24292e;">[root@localhost ~]# yum -y install openvpn easy-rsa</span></span></code></pre></div><ul><li>配置 easy-rsa-3.0</li></ul><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">#复制文件</span></span>
...
<span class="line"><span style="color:#24292e;">openvpn --genkey --secret ta.key</span></span></code></pre></div>`,33),o=[p];function t(c,r,i,y,d,u){return a(),e("div",null,o)}const m=s(l,[["render",t]]);export{v as __pageData,m as default};
