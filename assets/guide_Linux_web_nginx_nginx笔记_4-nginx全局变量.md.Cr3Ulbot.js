import{_ as s,c as n,o as e,R as a}from"./chunks/framework.CIzs38F0.js";const m=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"guide/Linux/web/nginx/nginx笔记/4-nginx全局变量.md","filePath":"guide/Linux/web/nginx/nginx笔记/4-nginx全局变量.md","lastUpdated":1701684699000}'),p={name:"guide/Linux/web/nginx/nginx笔记/4-nginx全局变量.md"},l=a(`<div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;"></span></span>
