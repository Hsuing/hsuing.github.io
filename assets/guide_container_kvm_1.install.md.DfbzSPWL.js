import{_ as s,c as n,o as a,R as e}from"./chunks/framework.CIzs38F0.js";const m=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"guide/container/kvm/1.install.md","filePath":"guide/container/kvm/1.install.md","lastUpdated":1714030813000}'),l={name:"guide/container/kvm/1.install.md"},p=e(`<h2 id="_1、先决条件" tabindex="-1">1、先决条件 <a class="header-anchor" href="#_1、先决条件" aria-label="Permalink to &quot;1、先决条件&quot;">​</a></h2><p>要运行带有2 GB以上RAM的guest虚拟机，您必须具有64位主机系统。 在继续安装之前，请确保您的Ubuntu主机支持KVM虚拟化。系统应具有带VT-x（vmx）的Intel处理器或具有AMD-V（svm）技术支持的AMD处理器</p><h3 id="_1-0查看cpu型号-物理cpu颗数" tabindex="-1">1.0查看cpu型号，物理cpu颗数 <a class="header-anchor" href="#_1-0查看cpu型号-物理cpu颗数" aria-label="Permalink to &quot;1.0查看cpu型号，物理cpu颗数&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">[root@kvm-node1 ~]# cat /proc/cpuinfo | grep name | cut -d: -f2 | uniq -c</span></span>
...
<span class="line"><span style="color:#24292e;">virbr0          8000.525400eb3239       yes             virbr0-nic</span></span></code></pre></div>`,26),o=[p];function c(t,i,r,y,d,v){return a(),n("div",null,o)}const h=s(l,[["render",c]]);export{m as __pageData,h as default};
