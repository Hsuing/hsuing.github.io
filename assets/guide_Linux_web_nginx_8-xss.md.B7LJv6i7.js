import{_ as e,c as n,I as a,w as t,R as l,D as p,o,a as c}from"./chunks/framework.CIzs38F0.js";const q=JSON.parse('{"title":"1,点击劫持","description":"","frontmatter":{},"headers":[],"relativePath":"guide/Linux/web/nginx/8-xss.md","filePath":"guide/Linux/web/nginx/8-xss.md","lastUpdated":1701684699000}'),r={name:"guide/Linux/web/nginx/8-xss.md"},i=l(`<h1 id="_1-点击劫持" tabindex="-1">1,点击劫持 <a class="header-anchor" href="#_1-点击劫持" aria-label="Permalink to &quot;1,点击劫持&quot;">​</a></h1><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;"># 点击劫持（ClickJacking）是一种视觉上的欺骗手段。大概有两种方式，</span></span>
...
<span class="line"><span style="color:#24292e;">content-security-policy: default-src *;script-src https://*.facebook.com http://*.facebook.com https://*.fbcdn.net http://*.fbcdn.net *.facebook.net *.google-analytics.com *.virtualearth.net *.google.com 127.0.0.1:* *.spotilocal.com:* chrome-extension://lifbcibllhkdhoafpjfnlhfpfgnpldfl &#39;unsafe-inline&#39; &#39;unsafe-eval&#39; https://*.akamaihd.net http://*.akamaihd.net;style-src * &#39;unsafe-inline&#39;;connect-src https://*.facebook.com http://*.facebook.com https://*.fbcdn.net http://*.fbcdn.net *.facebook.net *.spotilocal.com:* https://*.akamaihd.net ws://*.facebook.com:* http://*.akamaihd.net https://fb.scanandcleanlocal.com:*;</span></span></code></pre></div>`,61);function u(y,d,h,f,g,m){const s=p("center");return o(),n("div",null,[a(s,null,{default:t(()=>[c("Nginx 防止SQL注入、XSS攻击的实践配置方法")]),_:1}),i])}const b=e(r,[["render",u]]);export{q as __pageData,b as default};
