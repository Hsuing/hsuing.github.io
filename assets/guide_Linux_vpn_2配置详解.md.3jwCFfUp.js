import{_ as s,o as n,c as a,R as e}from"./chunks/framework.byfcZK4E.js";const g=JSON.parse('{"title":"三、","description":"","frontmatter":{},"headers":[],"relativePath":"guide/Linux/vpn/2配置详解.md","filePath":"guide/Linux/vpn/2配置详解.md","lastUpdated":1701595065000}'),p={name:"guide/Linux/vpn/2配置详解.md"},l=e(`<p>#一、server端</p><div class="danger custom-block"><p class="custom-block-title">❌ 注意</p><p>server端配置详解，针对多客户端的OpenVPN 2.2 的服务器端配置文件示例 &#39;#号&#39;和;号开头的都是注释</p></div><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">#该命令是可选的，如果不设置，则默认监听本机的所有IP地址。</span></span>
