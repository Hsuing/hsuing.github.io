import{_ as s,c as a,o as e,R as n}from"./chunks/framework.CIzs38F0.js";const g=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"guide/Database/pgSql/cluster/1.stream_sync.md","filePath":"guide/Database/pgSql/cluster/1.stream_sync.md","lastUpdated":1703063387000}'),l={name:"guide/Database/pgSql/cluster/1.stream_sync.md"},p=n(`<h2 id="_1-操作系统" tabindex="-1">1.操作系统 <a class="header-anchor" href="#_1-操作系统" aria-label="Permalink to &quot;1.操作系统&quot;">​</a></h2><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;"># sysctl -p </span></span>
...
<span class="line"><span style="color:#24292e;"></span></span>
<span class="line"><span style="color:#24292e;">SELECT pid,usename,client_addr,state, pg_wal_lsn_diff(pg_current_wal_lsn(),write_lsn) write_delay , pg_wal_lsn_diff(pg_current_wal_lsn(),flush_lsn) flush_delay, pg_wal_lsn_diff(pg_current_wal_lsn(),replay_lsn) replay_dely FROM pg_stat_replication;</span></span></code></pre></div>`,26),o=[p];function t(c,r,i,d,_,y){return e(),a("div",null,o)}const m=s(l,[["render",t]]);export{g as __pageData,m as default};
