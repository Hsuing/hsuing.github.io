import{_ as s,c as a,o as n,R as e}from"./chunks/framework.CIzs38F0.js";const h=JSON.parse('{"title":"gitlab域名修改","description":"","frontmatter":{},"headers":[],"relativePath":"guide/Linux/Gitlab/1-modify.md","filePath":"guide/Linux/Gitlab/1-modify.md","lastUpdated":1712917766000}'),l={name:"guide/Linux/Gitlab/1-modify.md"},p=e(`<h1 id="gitlab域名修改" tabindex="-1">gitlab域名修改 <a class="header-anchor" href="#gitlab域名修改" aria-label="Permalink to &quot;gitlab域名修改&quot;">​</a></h1><h2 id="_1-修改gitlab配置文件中host" tabindex="-1">1.修改gitlab配置文件中host <a class="header-anchor" href="#_1-修改gitlab配置文件中host" aria-label="Permalink to &quot;1.修改gitlab配置文件中host&quot;">​</a></h2><p>vi /opt/gitlab/embedded/service/gitlab-rails/config/gitlab.yml</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">gitlab:¬</span></span>
...
<span class="line"><span style="color:#24292e;">    }</span></span></code></pre></div><h2 id="_3-重启nginx和gitlab" tabindex="-1">3.重启nginx和gitlab <a class="header-anchor" href="#_3-重启nginx和gitlab" aria-label="Permalink to &quot;3.重启nginx和gitlab&quot;">​</a></h2><p>sudo gitlab-ctl restart</p><h2 id="_4-修改项目中gitlab-runner地址" tabindex="-1">4.修改项目中gitlab-runner地址 <a class="header-anchor" href="#_4-修改项目中gitlab-runner地址" aria-label="Permalink to &quot;4.修改项目中gitlab-runner地址&quot;">​</a></h2><p>vi /etc/gitlab-runner/config.toml</p><p>gitlab-runner restart</p><h1 id="充值密码" tabindex="-1">充值密码 <a class="header-anchor" href="#充值密码" aria-label="Permalink to &quot;充值密码&quot;">​</a></h1><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">sudo gitlab-rails console production</span></span>
<span class="line"><span style="color:#e1e4e8;">-------------------------------------------------------------------------------------</span></span>
...
<span class="line"><span style="color:#24292e;"></span></span>
<span class="line"><span style="color:#24292e;">irb(main):005:0&gt; exit</span></span></code></pre></div>`,14),t=[p];function o(i,c,r,d,g,b){return n(),a("div",null,t)}const y=s(l,[["render",o]]);export{h as __pageData,y as default};
