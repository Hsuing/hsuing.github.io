import{_ as s,c as n,o as e,R as a}from"./chunks/framework.CIzs38F0.js";const v=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"guide/container/containerd/2-toml.md","filePath":"guide/container/containerd/2-toml.md","lastUpdated":1713620605000}'),o={name:"guide/container/containerd/2-toml.md"},l=a(`<div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark has-diff vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">[plugins]</span></span>
