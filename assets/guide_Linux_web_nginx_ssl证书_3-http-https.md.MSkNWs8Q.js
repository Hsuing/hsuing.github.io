import{_ as s,o as e,c as n,R as a}from"./chunks/framework.byfcZK4E.js";const y=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"guide/Linux/web/nginx/ssl证书/3-http-https.md","filePath":"guide/Linux/web/nginx/ssl证书/3-http-https.md","lastUpdated":1701684699000}'),l={name:"guide/Linux/web/nginx/ssl证书/3-http-https.md"},p=a(`<ul><li>1种</li></ul><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">if ($scheme = http ) {</span></span>
