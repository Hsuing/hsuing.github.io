import{_ as s,c as a,o as n,R as l}from"./chunks/framework.CIzs38F0.js";const C=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"guide/Database/etcd/1-sigle.md","filePath":"guide/Database/etcd/1-sigle.md","lastUpdated":1703141608000}'),p={name:"guide/Database/etcd/1-sigle.md"},o=l(`<h2 id="_1-下载" tabindex="-1">1.下载 <a class="header-anchor" href="#_1-下载" aria-label="Permalink to &quot;1.下载&quot;">​</a></h2><p>wget <a href="https://github.com/etcd-io/etcd/releases/download/v3.4.13/etcd-v3.4.13-linux-amd64.tar.gz" target="_blank" rel="noreferrer">https://github.com/etcd-io/etcd/releases/download/v3.4.13/etcd-v3.4.13-linux-amd64.tar.gz</a></p><h2 id="_2-安装" tabindex="-1">2.安装 <a class="header-anchor" href="#_2-安装" aria-label="Permalink to &quot;2.安装&quot;">​</a></h2><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">cp etcd etcdctl /usr/bin/</span></span>
...
<span class="line"><span style="color:#6F42C1;">如果指定了listen-client-urls，则必须同时指定advertise-client-urls，否则会报错</span></span></code></pre></div>`,18),e=[o];function t(c,r,E,y,i,d){return n(),a("div",null,e)}const u=s(p,[["render",t]]);export{C as __pageData,u as default};
