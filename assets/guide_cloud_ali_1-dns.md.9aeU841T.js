import{_ as n,D as a,o as e,c as p,I as l,w as o,R as t,a as c}from"./chunks/framework.PZ77rLUR.js";const g=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"guide/cloud/ali/1-dns.md","filePath":"guide/cloud/ali/1-dns.md","lastUpdated":1701247404000}'),i={name:"guide/cloud/ali/1-dns.md"},r=t(`<ul><li>定时任务检查域名解析，调用alidns.sh更新DNS解析</li></ul><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">#!/bin/bash</span></span>
