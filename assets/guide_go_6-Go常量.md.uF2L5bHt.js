import{_ as s,o as n,c as a,R as l}from"./chunks/framework.byfcZK4E.js";const C=JSON.parse('{"title":"1.go语言常量","description":"","frontmatter":{},"headers":[],"relativePath":"guide/go/6-Go常量.md","filePath":"guide/go/6-Go常量.md","lastUpdated":1701229860000}'),p={name:"guide/go/6-Go常量.md"},o=l(`<p><a href="https://haicoder.net/golang/golang-float.html" target="_blank" rel="noreferrer">https://haicoder.net/golang/golang-float.html</a></p><h1 id="_1-go语言常量" tabindex="-1">1.go语言常量 <a class="header-anchor" href="#_1-go语言常量" aria-label="Permalink to &quot;1.go语言常量&quot;">​</a></h1><p>常量，就是程序<code>编译阶段</code>就确定下来的值，而程序在<code>运行时</code>则无法改变该值。g在Go程序里，常量可以是数值类型（包括整型、浮点型和复数类型）、布尔类型、字符串类型等。</p><h2 id="_1-1定义常量的语法" tabindex="-1">1.1定义常量的语法 <a class="header-anchor" href="#_1-1定义常量的语法" aria-label="Permalink to &quot;1.1定义常量的语法&quot;">​</a></h2><h3 id="const" tabindex="-1">const <a class="header-anchor" href="#const" aria-label="Permalink to &quot;const&quot;">​</a></h3><p>定义一个常量使用const关键字，语法格式如下</p><div class="language-go vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">go</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#F97583;">const</span><span style="color:#E1E4E8;"> constantName [type]</span><span style="color:#F97583;">=</span><span style="color:#E1E4E8;"> value</span></span>
