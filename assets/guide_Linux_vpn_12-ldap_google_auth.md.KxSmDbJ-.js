import{_ as s,o as n,c as a,R as e}from"./chunks/framework.byfcZK4E.js";const g=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"guide/Linux/vpn/12-ldap_google_auth.md","filePath":"guide/Linux/vpn/12-ldap_google_auth.md","lastUpdated":1701928035000}'),p={name:"guide/Linux/vpn/12-ldap_google_auth.md"},l=e(`<p>以下都是在openvpn server端执行</p><h2 id="_1-server端配置" tabindex="-1">1.server端配置 <a class="header-anchor" href="#_1-server端配置" aria-label="Permalink to &quot;1.server端配置&quot;">​</a></h2><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">port 1194</span></span>
