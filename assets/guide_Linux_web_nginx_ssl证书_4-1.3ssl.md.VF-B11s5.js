import{_ as s,o as n,c as a,R as e}from"./chunks/framework.PZ77rLUR.js";const _=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"guide/Linux/web/nginx/ssl证书/4-1.3ssl.md","filePath":"guide/Linux/web/nginx/ssl证书/4-1.3ssl.md","lastUpdated":1701684699000}'),l={name:"guide/Linux/web/nginx/ssl证书/4-1.3ssl.md"},p=e(`<p>Nginx 配置文件 server 段添加 ssl_protocols TLSv1.3;</p><p>TLSv1.3 现行 cipher 只有以下三种：</p><p>TLS-AES-128-GCM-SHA256 TLS-AES-256-GCM-SHA384 TLS-CHACHA20-POLY1305-SHA256</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">server {</span></span>
