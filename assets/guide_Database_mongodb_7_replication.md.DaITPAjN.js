import{_ as s,c as n,o as a,R as e}from"./chunks/framework.CIzs38F0.js";const q=JSON.parse('{"title":"1.系统设置","description":"","frontmatter":{},"headers":[],"relativePath":"guide/Database/mongodb/7_replication.md","filePath":"guide/Database/mongodb/7_replication.md","lastUpdated":1704853811000}'),l={name:"guide/Database/mongodb/7_replication.md"},t=e(`<h1 id="_1-系统设置" tabindex="-1">1.系统设置 <a class="header-anchor" href="#_1-系统设置" aria-label="Permalink to &quot;1.系统设置&quot;">​</a></h1><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">禁用透明页</span></span>
