import{_ as s,o as e,c as n,R as a}from"./chunks/framework.byfcZK4E.js";const g=JSON.parse('{"title":"Bitcion Core 目录说明","description":"","frontmatter":{},"headers":[],"relativePath":"guide/Blockchain/usdt/5-dir.md","filePath":"guide/Blockchain/usdt/5-dir.md","lastUpdated":1701401252000}'),p={name:"guide/Blockchain/usdt/5-dir.md"},l=a(`<h1 id="bitcion-core-目录说明" tabindex="-1">Bitcion Core 目录说明 <a class="header-anchor" href="#bitcion-core-目录说明" aria-label="Permalink to &quot;Bitcion Core 目录说明&quot;">​</a></h1><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">./</span></span>
