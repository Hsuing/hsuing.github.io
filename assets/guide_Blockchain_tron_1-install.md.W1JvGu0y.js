import{_ as s,c as n,o as a,R as e}from"./chunks/framework.CIzs38F0.js";const m=JSON.parse('{"title":"全节点和超级节点搭建","description":"","frontmatter":{},"headers":[],"relativePath":"guide/Blockchain/tron/1-install.md","filePath":"guide/Blockchain/tron/1-install.md","lastUpdated":1702369831000}'),l={name:"guide/Blockchain/tron/1-install.md"},p=e(`<h1 id="全节点和超级节点搭建" tabindex="-1">全节点和超级节点搭建 <a class="header-anchor" href="#全节点和超级节点搭建" aria-label="Permalink to &quot;全节点和超级节点搭建&quot;">​</a></h1><p>环境：</p><pre><code>jdk1.8(oracle)
</code></pre><p>配置：</p><p>CPU：16核 内存：32G 带宽：100M SSD：500G以上</p><p>16x_32g，1.6T 需以内存的一半来控制，否则超过会出现内存溢出</p><p>用快照（默认是430g左右）拉数据块</p><h2 id="_1-部署" tabindex="-1">1，部署 <a class="header-anchor" href="#_1-部署" aria-label="Permalink to &quot;1，部署&quot;">​</a></h2><h3 id="源码" tabindex="-1">源码 <a class="header-anchor" href="#源码" aria-label="Permalink to &quot;源码&quot;">​</a></h3><p>git clone -b master <a href="https://github.com/tronprotocol/java-tron.git" target="_blank" rel="noreferrer">https://github.com/tronprotocol/java-tron.git</a></p><p>编译java-tron项目</p><p>cd ./java-tron</p><p>./gradlew build</p><h3 id="jar包" tabindex="-1">jar包 <a class="header-anchor" href="#jar包" aria-label="Permalink to &quot;jar包&quot;">​</a></h3><p>通过release直接获取最新版本jar包</p><p><a href="https://github.com/tronprotocol/java-tron/releases" target="_blank" rel="noreferrer">https://github.com/tronprotocol/java-tron/releases</a></p><p><strong>配置文件</strong></p><p><a href="https://github.com/tronprotocol/tron-deployment/blob/master/main_net_config.conf" target="_blank" rel="noreferrer">https://github.com/tronprotocol/tron-deployment/blob/master/main_net_config.conf</a></p><h2 id="_2-部署节点" tabindex="-1">2,<strong>部署节点</strong> <a class="header-anchor" href="#_2-部署节点" aria-label="Permalink to &quot;2,**部署节点**&quot;">​</a></h2><p>启动节点同步数据较慢，可通过数据快照直接下载最新数据后，解压至tron项目下的output-directory目录下，再进行同步。数据快照可以从<a href="https://cn.developers.tron.network/docs/%E6%95%B0%E6%8D%AE%E5%BA%93%E5%BF%AB%E7%85%A7%E5%A4%87%E4%BB%BD" target="_blank" rel="noreferrer">数据快照和使用</a>获取</p><div class="danger custom-block"><p class="custom-block-title">❌ 注意 ，快照新地址</p><p><a href="https://tronprotocol.github.io/documentation-zh/using_javatron/backup_restore/#lite-fullnode" target="_blank" rel="noreferrer">https://tronprotocol.github.io/documentation-zh/using_javatron/backup_restore/#lite-fullnode</a></p></div><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">nohup java -XX:MetaspaceSize=128M -XX:MaxMetaspaceSize=256M -Xms8g -Xmx16g -XX:+HeapDumpOnOutOfMemoryError -jar FullNode.jar  -c main_net_config.conf &amp;</span></span></code></pre><pre class="shiki github-light vp-code-light"><code><span class="line"><span style="color:#24292e;">nohup java -XX:MetaspaceSize=128M -XX:MaxMetaspaceSize=256M -Xms8g -Xmx16g -XX:+HeapDumpOnOutOfMemoryError -jar FullNode.jar  -c main_net_config.conf &amp;</span></span></code></pre></div><h3 id="_2-1加速插件" tabindex="-1">2.1加速插件 <a class="header-anchor" href="#_2-1加速插件" aria-label="Permalink to &quot;2.1加速插件&quot;">​</a></h3><p><a href="https://github.com/tronprotocol/documentation-zh/blob/master/docs/developers/archive-manifest.md" target="_blank" rel="noreferrer">https://github.com/tronprotocol/documentation-zh/blob/master/docs/developers/archive-manifest.md</a></p><p>关闭节点</p><p>kill -15 pid</p><h2 id="_3-配置文件" tabindex="-1">3.配置文件 <a class="header-anchor" href="#_3-配置文件" aria-label="Permalink to &quot;3.配置文件&quot;">​</a></h2><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark has-diff vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">net {</span></span>
