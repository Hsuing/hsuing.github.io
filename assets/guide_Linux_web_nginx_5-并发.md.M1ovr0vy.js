import{_ as s,o as n,c as a,R as e}from"./chunks/framework.PZ77rLUR.js";const p="/assets/port.GIndi7se.jpg",l="/assets/tcp.cV9TDBet.jpg",k=JSON.parse('{"title":"二、高并发状态下nginx的配置(20万并发)","description":"","frontmatter":{},"headers":[],"relativePath":"guide/Linux/web/nginx/5-并发.md","filePath":"guide/Linux/web/nginx/5-并发.md","lastUpdated":1701684699000}'),o={name:"guide/Linux/web/nginx/5-并发.md"},t=e(`<h2 id="查看httpd进程数" tabindex="-1">查看httpd进程数 <a class="header-anchor" href="#查看httpd进程数" aria-label="Permalink to &quot;查看httpd进程数&quot;">​</a></h2><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">ps -ef | grep httpd | wc -l </span></span>
