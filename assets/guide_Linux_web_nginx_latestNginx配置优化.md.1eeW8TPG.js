import{_ as s,o as n,c as e,R as a}from"./chunks/framework.PZ77rLUR.js";const l="/assets/image-20220321105634224.BedlTrQe.png",p="/assets/image-20220321105531626.p3H2a3VO.png",f=JSON.parse('{"title":"另一个维度来总结","description":"","frontmatter":{},"headers":[],"relativePath":"guide/Linux/web/nginx/latestNginx配置优化.md","filePath":"guide/Linux/web/nginx/latestNginx配置优化.md","lastUpdated":1701684699000}'),o={name:"guide/Linux/web/nginx/latestNginx配置优化.md"},t=a(`<h2 id="_1-隐藏版本信息" tabindex="-1">1. 隐藏版本信息 <a class="header-anchor" href="#_1-隐藏版本信息" aria-label="Permalink to &quot;1. 隐藏版本信息&quot;">​</a></h2><p>修改Nginx源码文件，此配置文件需要在nginx.conf的http中添加server_tokens off;开启nginx版本隐藏才能实现预期效果</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">[root@CentOS7 nginx-1.14.2]#vim src/http/ngx_http_header_filter_module.c</span></span>
