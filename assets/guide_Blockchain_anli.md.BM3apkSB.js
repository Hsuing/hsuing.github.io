import{_ as s,c as n,o as a,R as p}from"./chunks/framework.CIzs38F0.js";const h=JSON.parse('{"title":"一、撮合交易所搭建","description":"","frontmatter":{},"headers":[],"relativePath":"guide/Blockchain/anli.md","filePath":"guide/Blockchain/anli.md","lastUpdated":1701401252000}'),l={name:"guide/Blockchain/anli.md"},o=p(`<h1 id="一、撮合交易所搭建" tabindex="-1">一、撮合交易所搭建 <a class="header-anchor" href="#一、撮合交易所搭建" aria-label="Permalink to &quot;一、撮合交易所搭建&quot;">​</a></h1><p>启动顺序：</p><p>签名-----&gt;钱包----&gt;撮合</p><h1 id="二、签名" tabindex="-1">二、签名 <a class="header-anchor" href="#二、签名" aria-label="Permalink to &quot;二、签名&quot;">​</a></h1><h2 id="usdt" tabindex="-1">usdt <a class="header-anchor" href="#usdt" aria-label="Permalink to &quot;usdt&quot;">​</a></h2><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">#启动</span></span>
...
<span class="line"></span>
<span class="line"><span style="color:#24292E;">[service]</span></span>
<span class="line"><span style="color:#24292E;">mode</span><span style="color:#D73A49;">=</span><span style="color:#032F62;">client</span></span></code></pre></div>`,26),e=[o];function c(t,r,y,i,E,F){return a(),n("div",null,e)}const C=s(l,[["render",c]]);export{h as __pageData,C as default};
