import{_ as s,c as e,o as a,R as n}from"./chunks/framework.CIzs38F0.js";const b=JSON.parse('{"title":"pg_repack 回收表体积","description":"","frontmatter":{},"headers":[],"relativePath":"guide/Database/pgSql/base/plugin/10-pg_repack.md","filePath":"guide/Database/pgSql/base/plugin/10-pg_repack.md","lastUpdated":1711706009000}'),p={name:"guide/Database/pgSql/base/plugin/10-pg_repack.md"},l=n(`<h1 id="pg-repack-回收表体积" tabindex="-1">pg_repack 回收表体积 <a class="header-anchor" href="#pg-repack-回收表体积" aria-label="Permalink to &quot;pg_repack 回收表体积&quot;">​</a></h1><p>对于某些常进行archiver或者 purge操作的表而言，如果我们不定期回收表空间，则表体积会越涨越大。</p><p>但是pg自带的 vacuum full 在回收的过程中会阻塞读写操作，不能在生产环境直接运行。</p><p>因此，在生产环境 我们常用的表空间收缩工具是pg_squeeze 和 pg_repack</p><p>项目地址: <a href="https://github.com/reorg/pg_repack" target="_blank" rel="noreferrer">https://github.com/reorg/pg_repack</a></p><p>原理： 新建一个一模一样的影子表，然后拷贝原表的数据，最后rename替换原表。</p><p><code>注意： 待处理的表必须有主键</code></p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">yum install centos-release-scl-rh</span></span>
...
<span class="line"><span style="color:#24292e;">  -W, --password            force password prompt</span></span></code></pre></div>`,21),o=[l];function c(t,r,i,d,y,g){return a(),e("div",null,o)}const k=s(p,[["render",c]]);export{b as __pageData,k as default};
