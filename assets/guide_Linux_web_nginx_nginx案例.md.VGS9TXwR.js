import{_ as s,o as n,c as a,R as e}from"./chunks/framework.byfcZK4E.js";const l="/assets/1657867477553978._vn6UE87.png",p="/assets/3.v2WP6k5P.jpg",E=JSON.parse('{"title":"2.1 over HTTPS","description":"","frontmatter":{},"headers":[],"relativePath":"guide/Linux/web/nginx/nginx案例.md","filePath":"guide/Linux/web/nginx/nginx案例.md","lastUpdated":1701934023000}'),o={name:"guide/Linux/web/nginx/nginx案例.md"},t=e(`<h2 id="_1-1-nginx转发带应用名的url" tabindex="-1">1.1 Nginx转发带应用名的URL <a class="header-anchor" href="#_1-1-nginx转发带应用名的url" aria-label="Permalink to &quot;1.1 Nginx转发带应用名的URL&quot;">​</a></h2><ul><li>实现 原始URL：<a href="http://brand.uat.test.com/vendor/login.htm,%E5%A6%82%E4%BD%95%E9%85%8D%E7%BD%AENginx%E5%8F%AF%E4%BB%A5%E5%8F%AA%E8%BE%93%E5%85%A5http://brand.uat.test.com/%EF%BC%8C%E5%B0%B1%E8%83%BD%E6%AD%A3%E5%B8%B8%E8%AE%BF%E9%97%AE" target="_blank" rel="noreferrer">http://brand.uat.test.com/vendor/login.htm,如何配置Nginx可以只输入http://brand.uat.test.com/，就能正常访问</a></li></ul><div class="language-shell vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">shell</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#6A737D;">#vim /usr/local/nginx/conf/nginx.conf</span></span>
...
<span class="line"><span style="color:#24292e;">return 308 https://www.xxx.com$request_uri;</span></span></code></pre></div><ul><li><p>301 Moved Permanently</p><p>被请求的资源已永久移动到新位置，并且将来任何对此资源的引用都应该使用本响应返回的若干个 URI 之一</p></li><li><p>307 Temporary Redirect</p><p>请求的资源现在临时从不同的URI 响应请求。由于这样的重定向是临时的，客户端应当继续向原有地址发送以后的请求</p></li><li><p>308 永久重定向</p><p>308状态代码[永久重定向],类似于301(永久移动)，但不允许将请求方法从POST更改为GET.</p></li></ul><h5 id="_301和308的区别" tabindex="-1">301和308的区别 <a class="header-anchor" href="#_301和308的区别" aria-label="Permalink to &quot;301和308的区别&quot;">​</a></h5><p>在 HTTP 协议中， 308 Permanent Redirect（永久重定向）是表示重定向的响应状态码，说明请求的资源已经被永久的移动到了由 Location 首部指定的 URL 上。在重定向过程中，请求方法和消息主体不会发生改变!</p><p>然而在 301 状态码的情况下，请求方法有时候会被客户端错误地修改为 GET 方法</p><h1 id="_42-403自定义页面" tabindex="-1">42.403自定义页面 <a class="header-anchor" href="#_42-403自定义页面" aria-label="Permalink to &quot;42.403自定义页面&quot;">​</a></h1><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">cat 403.html</span></span>
<span class="line"><span style="color:#e1e4e8;">Page error</span></span>
<span class="line"><span style="color:#e1e4e8;"></span></span>
<span class="line"><span style="color:#e1e4e8;">放到网站主页面目录下</span></span>
<span class="line"><span style="color:#e1e4e8;">--------------------------------------</span></span>
<span class="line"><span style="color:#e1e4e8;"></span></span>
<span class="line"><span style="color:#e1e4e8;"></span></span>
<span class="line"><span style="color:#e1e4e8;">location / {</span></span>
<span class="line"><span style="color:#e1e4e8;">    allow   192.168.1.0/24;</span></span>
<span class="line"><span style="color:#e1e4e8;">    deny all;</span></span>
<span class="line"><span style="color:#e1e4e8;">    error_page 403 /403.html;</span></span>
<span class="line"><span style="color:#e1e4e8;">     location  /403.html {   </span></span>
<span class="line"><span style="color:#e1e4e8;">        allow   all;</span></span>
<span class="line"><span style="color:#e1e4e8;">     }</span></span>
<span class="line"><span style="color:#e1e4e8;">}</span></span></code></pre><pre class="shiki github-light vp-code-light"><code><span class="line"><span style="color:#24292e;">cat 403.html</span></span>
<span class="line"><span style="color:#24292e;">Page error</span></span>
<span class="line"><span style="color:#24292e;"></span></span>
<span class="line"><span style="color:#24292e;">放到网站主页面目录下</span></span>
<span class="line"><span style="color:#24292e;">--------------------------------------</span></span>
<span class="line"><span style="color:#24292e;"></span></span>
<span class="line"><span style="color:#24292e;"></span></span>
<span class="line"><span style="color:#24292e;">location / {</span></span>
<span class="line"><span style="color:#24292e;">    allow   192.168.1.0/24;</span></span>
<span class="line"><span style="color:#24292e;">    deny all;</span></span>
<span class="line"><span style="color:#24292e;">    error_page 403 /403.html;</span></span>
<span class="line"><span style="color:#24292e;">     location  /403.html {   </span></span>
...
<span class="line"><span style="color:#24292e;">    }</span></span></code></pre></div>`,267),c=[t];function r(i,y,d,h,u,g){return n(),a("div",null,c)}const m=s(o,[["render",r]]);export{E as __pageData,m as default};
