import{_ as s,c as n,o as a,R as l}from"./chunks/framework.CIzs38F0.js";const m=JSON.parse('{"title":"1.golang结构体","description":"","frontmatter":{},"headers":[],"relativePath":"guide/go/25-Go结构体.md","filePath":"guide/go/25-Go结构体.md","lastUpdated":1701229860000}'),p={name:"guide/go/25-Go结构体.md"},o=l(`<h1 id="_1-golang结构体" tabindex="-1">1.golang结构体 <a class="header-anchor" href="#_1-golang结构体" aria-label="Permalink to &quot;1.golang结构体&quot;">​</a></h1><p>go语言没有面向对象的概念了，但是可以使用结构体来实现，面向对象编程的一些特性，例如：继承、组合等特性。</p><h2 id="_1-1go语言结构体的定义" tabindex="-1">1.1go语言结构体的定义 <a class="header-anchor" href="#_1-1go语言结构体的定义" aria-label="Permalink to &quot;1.1go语言结构体的定义&quot;">​</a></h2><p>结构体的定义和类型定义类似，只不过多了一个<code>struct</code>关键字，语法结构如下：</p><div class="language-go vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">go</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#F97583;">type</span><span style="color:#E1E4E8;"> </span><span style="color:#B392F0;">struct_variable_type</span><span style="color:#E1E4E8;"> </span><span style="color:#F97583;">struct</span><span style="color:#E1E4E8;"> {</span></span>
<span class="line"><span style="color:#E1E4E8;">	member definition;</span></span>
<span class="line"><span style="color:#E1E4E8;">	member definition;</span></span>
...
<span class="line"><span style="color:#24292E;">	member definition;</span></span>
<span class="line"><span style="color:#24292E;">	member definition;</span></span>
<span class="line"><span style="color:#24292E;">	</span><span style="color:#D73A49;">...</span></span>
<span class="line"><span style="color:#24292E;">	member definition;</span></span>
<span class="line"><span style="color:#24292E;">}</span></span></code></pre></div><p><code>type</code>:结构体定义关键字</p><p><code>struct_variable_type</code>:结构体类型名称</p><p><code>struct</code>:结构体定义关键字</p><p><code>member definition</code>: 成员定义</p><h4 id="实例" tabindex="-1">实例： <a class="header-anchor" href="#实例" aria-label="Permalink to &quot;实例：&quot;">​</a></h4><p>定义Person 的结构体</p><div class="language-go vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">go</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#F97583;">type</span><span style="color:#E1E4E8;"> </span><span style="color:#B392F0;">Person</span><span style="color:#E1E4E8;"> </span><span style="color:#F97583;">struct</span><span style="color:#E1E4E8;"> {</span></span>
...
<span class="line"><span style="color:#24292E;">}</span></span></code></pre></div>`,140),e=[o];function t(c,r,i,y,E,d){return a(),n("div",null,e)}const g=s(p,[["render",t]]);export{m as __pageData,g as default};
