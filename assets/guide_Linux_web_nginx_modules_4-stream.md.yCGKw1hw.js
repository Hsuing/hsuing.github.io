import{_ as s,o as n,c as a,R as e}from"./chunks/framework.PZ77rLUR.js";const m=JSON.parse('{"title":"一、tcp 代理","description":"","frontmatter":{},"headers":[],"relativePath":"guide/Linux/web/nginx/modules/4-stream.md","filePath":"guide/Linux/web/nginx/modules/4-stream.md","lastUpdated":1701684699000}'),l={name:"guide/Linux/web/nginx/modules/4-stream.md"},p=e(`<h1 id="一、tcp-代理" tabindex="-1">一、tcp 代理 <a class="header-anchor" href="#一、tcp-代理" aria-label="Permalink to &quot;一、tcp 代理&quot;">​</a></h1><p>使用Nginx做tcp的反向代理，目前1.7至1.9版本需要加载[nginx_tcp_proxy_module]模块，1.9之后可以使用[--with-stream]模块</p><h2 id="语法" tabindex="-1">语法 <a class="header-anchor" href="#语法" aria-label="Permalink to &quot;语法&quot;">​</a></h2><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">stream 和http同级</span></span>
