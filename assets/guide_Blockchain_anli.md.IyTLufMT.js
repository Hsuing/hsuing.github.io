import{_ as s,o as n,c as a,R as p}from"./chunks/framework.byfcZK4E.js";const h=JSON.parse('{"title":"一、撮合交易所搭建","description":"","frontmatter":{},"headers":[],"relativePath":"guide/Blockchain/anli.md","filePath":"guide/Blockchain/anli.md","lastUpdated":1701401252000}'),l={name:"guide/Blockchain/anli.md"},o=p(`<h1 id="一、撮合交易所搭建" tabindex="-1">一、撮合交易所搭建 <a class="header-anchor" href="#一、撮合交易所搭建" aria-label="Permalink to &quot;一、撮合交易所搭建&quot;">​</a></h1><p>启动顺序：</p><p>签名-----&gt;钱包----&gt;撮合</p><h1 id="二、签名" tabindex="-1">二、签名 <a class="header-anchor" href="#二、签名" aria-label="Permalink to &quot;二、签名&quot;">​</a></h1><h2 id="usdt" tabindex="-1">usdt <a class="header-anchor" href="#usdt" aria-label="Permalink to &quot;usdt&quot;">​</a></h2><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">#启动</span></span>
