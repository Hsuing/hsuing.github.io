import{_ as s,c as a,o as n,R as e}from"./chunks/framework.CIzs38F0.js";const u=JSON.parse('{"title":"1.添加辅助网卡","description":"","frontmatter":{},"headers":[],"relativePath":"guide/cloud/ali/3-network.md","filePath":"guide/cloud/ali/3-network.md","lastUpdated":1701247404000}'),p={name:"guide/cloud/ali/3-network.md"},l=e(`<h1 id="_1-添加辅助网卡" tabindex="-1">1.添加辅助网卡 <a class="header-anchor" href="#_1-添加辅助网卡" aria-label="Permalink to &quot;1.添加辅助网卡&quot;">​</a></h1><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">[root@openvpn network-scripts]# cat ifcfg-eth1 </span></span>
