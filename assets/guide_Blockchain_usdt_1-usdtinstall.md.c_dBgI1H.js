import{_ as s,c as a,o as n,R as e}from"./chunks/framework.CIzs38F0.js";const b=JSON.parse('{"title":"1.下载","description":"","frontmatter":{},"headers":[],"relativePath":"guide/Blockchain/usdt/1-usdtinstall.md","filePath":"guide/Blockchain/usdt/1-usdtinstall.md","lastUpdated":1701401252000}'),l={name:"guide/Blockchain/usdt/1-usdtinstall.md"},p=e(`<h1 id="_1-下载" tabindex="-1">1.下载 <a class="header-anchor" href="#_1-下载" aria-label="Permalink to &quot;1.下载&quot;">​</a></h1><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">https://www.omnilayer.org/download.html</span></span>
