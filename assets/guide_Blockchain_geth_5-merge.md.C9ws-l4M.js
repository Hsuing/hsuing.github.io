...
<span class="line"><span style="color:#24292e;">sh prysm.sh</span></span></code></pre></div><h3 id="_2-2jwt-身份验证" tabindex="-1">2.2JWT 身份验证 <a class="header-anchor" href="#_2-2jwt-身份验证" aria-label="Permalink to &quot;2.2JWT 身份验证&quot;">​</a></h3><p>两种方式随机取一</p><ul><li>1.openssl</li></ul><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">openssl rand -hex 32 | tr -d &quot;\\n&quot; &gt; &quot;jwt.hex&quot;</span></span></code></pre><pre class="shiki github-light vp-code-light"><code><span class="line"><span style="color:#24292e;">openssl rand -hex 32 | tr -d &quot;\\n&quot; &gt; &quot;jwt.hex&quot;</span></span></code></pre></div><ul><li>2.prysm</li></ul><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">./prysm.sh beacon-chain generate-auth-secret</span></span></code></pre><pre class="shiki github-light vp-code-light"><code><span class="line"><span style="color:#24292e;">./prysm.sh beacon-chain generate-auth-secret</span></span></code></pre></div><h3 id="_2-3启动" tabindex="-1">2.3启动 <a class="header-anchor" href="#_2-3启动" aria-label="Permalink to &quot;2.3启动&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">./prysm.sh beacon-chain --execution-endpoint=http://127.0.0.1:8551  --jwt-secret=/data/apps/prysm/jwt.hex</span></span>
<span class="line"><span style="color:#e1e4e8;"></span></span>
<span class="line"><span style="color:#e1e4e8;">#默认启动数据存放到/root/.eth2 目录下</span></span>
<span class="line"><span style="color:#e1e4e8;">--execution-endpoint  指定eth块服务</span></span>
<span class="line"><span style="color:#e1e4e8;">--datadir=  指定数据路径</span></span></code></pre><pre class="shiki github-light vp-code-light"><code><span class="line"><span style="color:#24292e;">./prysm.sh beacon-chain --execution-endpoint=http://127.0.0.1:8551  --jwt-secret=/data/apps/prysm/jwt.hex</span></span>
<span class="line"><span style="color:#24292e;"></span></span>
<span class="line"><span style="color:#24292e;">#默认启动数据存放到/root/.eth2 目录下</span></span>
<span class="line"><span style="color:#24292e;">--execution-endpoint  指定eth块服务</span></span>
<span class="line"><span style="color:#24292e;">--datadir=  指定数据路径</span></span></code></pre></div><p>操作顺序，1.先制作hex密钥，2.启动eth，3.启动prysm</p><ul><li>systemd启动</li></ul><div class="language-bash vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#E1E4E8;">[program:prysm]</span></span>
...
<span class="line"><span style="color:#24292E;">  </span><span style="color:#005CC5;">--accept-terms-of-use=true</span></span></code></pre></div>`,61),o=[l];function t(c,r,i,d,y,h){return n(),a("div",null,o)}const m=s(p,[["render",t]]);export{g as __pageData,m as default};
