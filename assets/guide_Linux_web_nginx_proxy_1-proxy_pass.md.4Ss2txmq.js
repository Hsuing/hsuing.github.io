import{_ as s,o as a,c as n,R as p}from"./chunks/framework.PZ77rLUR.js";const _=JSON.parse('{"title":"一、proxy_pass","description":"","frontmatter":{},"headers":[],"relativePath":"guide/Linux/web/nginx/proxy/1-proxy_pass.md","filePath":"guide/Linux/web/nginx/proxy/1-proxy_pass.md","lastUpdated":1701684699000}'),l={name:"guide/Linux/web/nginx/proxy/1-proxy_pass.md"},e=p(`<h1 id="一、proxy-pass" tabindex="-1">一、proxy_pass <a class="header-anchor" href="#一、proxy-pass" aria-label="Permalink to &quot;一、proxy_pass&quot;">​</a></h1><ul><li>Nginx proxy_pass 后面的url 加/与不加/的区别</li></ul><blockquote><p>[!TIP] 在nginx中配置proxy_pass时，当在后面的url加上了/，相当于是绝对根路径，则nginx不会把location中匹配的路径部分代理走;</p></blockquote><blockquote><p>如果没有/，则会把匹配的路径部分也给代理走</p></blockquote><ul><li>第一种</li></ul><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">location  /proxy/ {</span></span>
