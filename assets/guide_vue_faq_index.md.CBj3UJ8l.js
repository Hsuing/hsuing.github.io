import{_ as s,c as n,o as a,R as e}from"./chunks/framework.CIzs38F0.js";const h=JSON.parse('{"title":"1.vue3+vite+ts打包时报错","description":"","frontmatter":{},"headers":[],"relativePath":"guide/vue/faq/index.md","filePath":"guide/vue/faq/index.md","lastUpdated":1711723151000}'),l={name:"guide/vue/faq/index.md"},p=e(`<h1 id="_1-vue3-vite-ts打包时报错" tabindex="-1">1.vue3+vite+ts打包时报错 <a class="header-anchor" href="#_1-vue3-vite-ts打包时报错" aria-label="Permalink to &quot;1.vue3+vite+ts打包时报错&quot;">​</a></h1><ul><li>现象</li></ul><p><strong>Ineffective mark-compacts near heap limit Allocation failed - JavaScript heap out of memory</strong></p><ul><li>解决方式</li></ul><div class="language-shell vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">shell</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#6A737D;">#1</span></span>
...
<span class="line"><span style="color:#24292e;">    }</span></span>
<span class="line"><span style="color:#24292e;">  }</span></span>
<span class="line"><span style="color:#24292e;">}</span></span></code></pre></div>`,11),o=[p];function c(t,i,r,y,d,u){return a(),n("div",null,o)}const g=s(l,[["render",c]]);export{h as __pageData,g as default};
