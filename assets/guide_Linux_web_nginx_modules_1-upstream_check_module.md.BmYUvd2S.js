import{_ as s,c as n,o as a,R as e}from"./chunks/framework.CIzs38F0.js";const l="/assets/nginxcheckupstream.CqEkl3Vp.jpg",p="/assets/nginxcheckupdown.CxVw5QTv.jpg",t="/assets/nginxcheckjson.CNmCE9Gp.jpg",g=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"guide/Linux/web/nginx/modules/1-upstream_check_module.md","filePath":"guide/Linux/web/nginx/modules/1-upstream_check_module.md","lastUpdated":1701684699000}'),c={name:"guide/Linux/web/nginx/modules/1-upstream_check_module.md"},o=e(`<ul><li><p>安装省略。。。</p></li><li><p>1.配置</p></li></ul><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">upstream  operationApi {</span></span>
...
<span class="line"><span style="color:#24292e;">	check_keepalive_requests 100;</span></span>
<span class="line"><span style="color:#24292e;">}</span></span></code></pre></div>`,21),i=[o];function r(y,h,u,_,d,v){return a(),n("div",null,i)}const k=s(c,[["render",r]]);export{g as __pageData,k as default};
