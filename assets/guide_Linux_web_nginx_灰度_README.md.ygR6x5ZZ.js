import{_ as s,o as e,c as n,R as a}from"./chunks/framework.byfcZK4E.js";const h=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"guide/Linux/web/nginx/灰度/README.md","filePath":"guide/Linux/web/nginx/灰度/README.md","lastUpdated":1701684699000}'),p={name:"guide/Linux/web/nginx/灰度/README.md"},l=a(`<p>灰度发布可以保证整体系统的稳定，在初始灰度的时候就可以发现、调整问题，以保证其影响度</p><p>灰度发布常见一般有三种方式:</p><p>Nginx+LUA方式</p><p>根据Cookie实现灰度发布</p><p>根据来路IP实现灰度发布</p><ul><li>特点</li></ul><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">保证整体系统稳定性，在初始灰度的时候就可以发现、调整问题，影响范围可控；</span></span>
