import{_ as s,o as e,c as a,R as n}from"./chunks/framework.PZ77rLUR.js";const u=JSON.parse('{"title":"查看修改 更新证书计划","description":"","frontmatter":{},"headers":[],"relativePath":"guide/Linux/web/nginx/ssl证书/1-申请证书.md","filePath":"guide/Linux/web/nginx/ssl证书/1-申请证书.md","lastUpdated":1701684699000}'),l={name:"guide/Linux/web/nginx/ssl证书/1-申请证书.md"},p=n(`<p>acme.sh 实现了 acme 协议, 可以从 letsencrypt 生成免费的证书</p><h2 id="_1-安装-acme-sh" tabindex="-1">1. 安装 acme.sh <a class="header-anchor" href="#_1-安装-acme-sh" aria-label="Permalink to &quot;1. 安装 acme.sh&quot;">​</a></h2><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">curl  https://get.acme.sh | sh</span></span>
