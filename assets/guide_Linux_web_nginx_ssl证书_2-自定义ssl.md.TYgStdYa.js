import{_ as s,o as n,c as e,R as a}from"./chunks/framework.byfcZK4E.js";const O=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"guide/Linux/web/nginx/ssl证书/2-自定义ssl.md","filePath":"guide/Linux/web/nginx/ssl证书/2-自定义ssl.md","lastUpdated":1701684699000}'),l={name:"guide/Linux/web/nginx/ssl证书/2-自定义ssl.md"},p=a(`<ul><li>自签名证书申请</li></ul><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">#!/bin/sh</span></span>
