import{_ as s,o as a,c as e,R as n}from"./chunks/framework.PZ77rLUR.js";const g=JSON.parse('{"title":"2. 源码安装 geth","description":"","frontmatter":{},"headers":[],"relativePath":"guide/Blockchain/geth/1-install.md","filePath":"guide/Blockchain/geth/1-install.md","lastUpdated":1701401252000}'),l={name:"guide/Blockchain/geth/1-install.md"},p=n(`<blockquote><p>机器配置</p></blockquote><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">高级配置</span></span>
