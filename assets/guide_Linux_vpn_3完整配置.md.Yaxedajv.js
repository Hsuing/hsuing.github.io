import{_ as s,o as n,c as e,R as a}from"./chunks/framework.byfcZK4E.js";const h=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"guide/Linux/vpn/3完整配置.md","filePath":"guide/Linux/vpn/3完整配置.md","lastUpdated":1701595065000}'),p={name:"guide/Linux/vpn/3完整配置.md"},l=a(`<p>#server端</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">#进入到如下目录</span></span>
