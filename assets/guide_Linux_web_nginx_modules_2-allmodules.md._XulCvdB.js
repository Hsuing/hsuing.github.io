import{_ as s,o as n,c as e,R as a}from"./chunks/framework.PZ77rLUR.js";const u=JSON.parse('{"title":"1.0 chunked_transfer_encoding","description":"","frontmatter":{},"headers":[],"relativePath":"guide/Linux/web/nginx/modules/2-allmodules.md","filePath":"guide/Linux/web/nginx/modules/2-allmodules.md","lastUpdated":1701684699000}'),p={name:"guide/Linux/web/nginx/modules/2-allmodules.md"},l=a(`<h1 id="_1-0-chunked-transfer-encoding" tabindex="-1">1.0 chunked_transfer_encoding <a class="header-anchor" href="#_1-0-chunked-transfer-encoding" aria-label="Permalink to &quot;1.0 chunked_transfer_encoding&quot;">​</a></h1><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">启用 GZip 所需的 HTTP 最低版本</span></span>
