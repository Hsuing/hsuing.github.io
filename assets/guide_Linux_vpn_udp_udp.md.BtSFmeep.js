import{_ as s,o as n,c as e,R as a}from"./chunks/framework.PZ77rLUR.js";const h=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"guide/Linux/vpn/udp/udp.md","filePath":"guide/Linux/vpn/udp/udp.md","lastUpdated":1701595065000}'),p={name:"guide/Linux/vpn/udp/udp.md"},l=a(`<h2 id="_1-iptables" tabindex="-1">1.iptables <a class="header-anchor" href="#_1-iptables" aria-label="Permalink to &quot;1.iptables&quot;">​</a></h2><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;"># 如下网段记得与server.conf 当中定义的网段保持一致</span></span>
