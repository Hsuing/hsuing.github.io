import{_ as s,o as a,c as n,R as e}from"./chunks/framework.PZ77rLUR.js";const h=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"guide/Linux/web/nginx/灰度/Geoip城市的灰度发布.md","filePath":"guide/Linux/web/nginx/灰度/Geoip城市的灰度发布.md","lastUpdated":1701684699000}'),p={name:"guide/Linux/web/nginx/灰度/Geoip城市的灰度发布.md"},l=e(`<h2 id="_1-安装epel源" tabindex="-1">1.安装epel源 <a class="header-anchor" href="#_1-安装epel源" aria-label="Permalink to &quot;1.安装epel源&quot;">​</a></h2><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">wget https://dl.fedoraproject.org/pub/epel/6/x86_64/epel-release-6-8.noarch.rpm</span></span>
