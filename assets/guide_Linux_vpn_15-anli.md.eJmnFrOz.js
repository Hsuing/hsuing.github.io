import{_ as s,o as n,c as a,R as e}from"./chunks/framework.byfcZK4E.js";const g=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"guide/Linux/vpn/15-anli.md","filePath":"guide/Linux/vpn/15-anli.md","lastUpdated":1701595065000}'),p={name:"guide/Linux/vpn/15-anli.md"},l=e(`<h2 id="一、案例1" tabindex="-1"><strong>一、案例1</strong> <a class="header-anchor" href="#一、案例1" aria-label="Permalink to &quot;**一、案例1**&quot;">​</a></h2><p>**针对不同的客户端指定不同的等级和权限。**通常的方法是： 1、每个客户端分配不同的IP地址； 2、利用防火墙对不同的IP地址进行控制；</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">例如：</span></span>
