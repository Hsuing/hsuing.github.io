import{_ as s,c as n,o as a,R as e}from"./chunks/framework.CIzs38F0.js";const u=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"guide/Linux/web/nginx/modules/8-map.md","filePath":"guide/Linux/web/nginx/modules/8-map.md","lastUpdated":1701684699000}'),l={name:"guide/Linux/web/nginx/modules/8-map.md"},p=e(`<ul><li>map</li></ul><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">map $http_host $name {</span></span>
...
<span class="line"><span style="color:#24292e;">3:0</span></span></code></pre></div>`,2),o=[p];function c(t,i,r,m,y,d){return a(),n("div",null,o)}const _=s(l,[["render",c]]);export{u as __pageData,_ as default};
