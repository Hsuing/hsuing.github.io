import{_ as s,c as e,o as n,R as a}from"./chunks/framework.CIzs38F0.js";const x=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"guide/Linux/web/nginx/loadBalance/2-backup.md","filePath":"guide/Linux/web/nginx/loadBalance/2-backup.md","lastUpdated":1701928035000}'),p={name:"guide/Linux/web/nginx/loadBalance/2-backup.md"},l=a(`<p>只要在希望成为后备的服务器ip后面多添加一个backup参数，这台服务器就会成为备份服务器。 在平时不使用，nginx不会给它转发任何请求。只有当其他节点全部无法连接的时候，nginx才会启用这个节点。 一旦有可用的节点恢复服务，该节点则不再使用，又进入后备状态</p><p>nginx backup 功能已实现，404 页面不转到备机， 502 503 504 到备机</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">配置如下</span></span>
