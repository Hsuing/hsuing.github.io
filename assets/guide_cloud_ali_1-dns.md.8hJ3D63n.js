import{_ as n,c as a,I as e,w as p,R as l,D as o,o as t,a as c}from"./chunks/framework.CIzs38F0.js";const g=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"guide/cloud/ali/1-dns.md","filePath":"guide/cloud/ali/1-dns.md","lastUpdated":1701247404000}'),i={name:"guide/cloud/ali/1-dns.md"},r=l(`<ul><li>定时任务检查域名解析，调用alidns.sh更新DNS解析</li></ul><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">#!/bin/bash</span></span>
...
<span class="line"><span style="color:#24292e;">##############################</span></span></code></pre></div>`,2);function u(q,y,d,$,m,h){const s=o("center");return t(),a("div",null,[e(s,null,{default:p(()=>[c("阿里云DNS api接口 shell 更改DNS解析")]),_:1}),r])}const S=n(i,[["render",u]]);export{g as __pageData,S as default};
