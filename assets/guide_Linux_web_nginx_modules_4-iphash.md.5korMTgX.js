import{_ as a,D as n,c as e,I as p,w as l,R as o,o as r,a as c}from"./chunks/framework.CIzs38F0.js";const $=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"guide/Linux/web/nginx/modules/4-iphash.md","filePath":"guide/Linux/web/nginx/modules/4-iphash.md","lastUpdated":1701684699000}'),t={name:"guide/Linux/web/nginx/modules/4-iphash.md"},i=o(`<p>下四种负载均衡的算法，分别是：round-robin、ip-hash、least-connected和weighted</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">upstream h5 {</span></span>
...
<span class="line"><span style="color:#24292e;">    }</span></span></code></pre></div>`,5);function d(y,_,h,f,F,u){const s=n("center");return r(),e("div",null,[p(s,null,{default:l(()=>[c("nginx使用用户真实IP做hash（解决经过CND后ip_hash失效问题）")]),_:1}),i])}const x=a(t,[["render",d]]);export{$ as __pageData,x as default};
