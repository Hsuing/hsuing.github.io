import{_ as s,c as n,o as a,R as e}from"./chunks/framework.CIzs38F0.js";const h=JSON.parse('{"title":"一、 location匹配顺序","description":"","frontmatter":{},"headers":[],"relativePath":"guide/Linux/web/nginx/1-location.md","filePath":"guide/Linux/web/nginx/1-location.md","lastUpdated":1701684699000}'),l={name:"guide/Linux/web/nginx/1-location.md"},p=e(`<h1 id="一、-location匹配顺序" tabindex="-1">一、 location匹配顺序 <a class="header-anchor" href="#一、-location匹配顺序" aria-label="Permalink to &quot;一、 location匹配顺序&quot;">​</a></h1><ul><li>location 测试工具</li></ul><p><a href="https://detailyang.github.io/nginx-location-match-visible/" target="_blank" rel="noreferrer">https://detailyang.github.io/nginx-location-match-visible/</a></p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">location  = / {</span></span>
...
<span class="line"><span style="color:#24292e;">}</span></span></code></pre></div><p><a href="https://www.jianshu.com/p/38810b49bc29" target="_blank" rel="noreferrer">https://www.jianshu.com/p/38810b49bc29</a></p>`,17),o=[p];function c(i,t,r,y,g,d){return a(),n("div",null,o)}const f=s(l,[["render",c]]);export{h as __pageData,f as default};
