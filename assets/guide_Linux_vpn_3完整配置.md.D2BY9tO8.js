import{_ as s,c as n,o as e,R as a}from"./chunks/framework.CIzs38F0.js";const h=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"guide/Linux/vpn/3完整配置.md","filePath":"guide/Linux/vpn/3完整配置.md","lastUpdated":1701595065000}'),p={name:"guide/Linux/vpn/3完整配置.md"},l=a(`<p>#server端</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">#进入到如下目录</span></span>
...
<span class="line"><span style="color:#24292e;">verb 3</span></span></code></pre></div>`,4),o=[l];function c(t,r,i,y,d,u){return e(),n("div",null,o)}const g=s(p,[["render",c]]);export{h as __pageData,g as default};
