import{_ as a,D as n,o as e,c as p,I as l,w as o,R as r,a as c}from"./chunks/framework.PZ77rLUR.js";const $=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"guide/Linux/web/nginx/modules/4-iphash.md","filePath":"guide/Linux/web/nginx/modules/4-iphash.md","lastUpdated":1701684699000}'),t={name:"guide/Linux/web/nginx/modules/4-iphash.md"},i=r(`<p>下四种负载均衡的算法，分别是：round-robin、ip-hash、least-connected和weighted</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">upstream h5 {</span></span>
