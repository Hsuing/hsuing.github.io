import{_ as s,c as n,o as a,R as e}from"./chunks/framework.CIzs38F0.js";const b=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"guide/Database/pgSql/base/日常使用规范的总结.md","filePath":"guide/Database/pgSql/base/日常使用规范的总结.md","lastUpdated":1711535325000}'),p={name:"guide/Database/pgSql/base/日常使用规范的总结.md"},l=e(`<h2 id="事务设计规范" tabindex="-1">事务设计规范 <a class="header-anchor" href="#事务设计规范" aria-label="Permalink to &quot;事务设计规范&quot;">​</a></h2><p>高并发场景，有时候会看到开发同学将很长的事务逻辑放在一个事务里面实现，其实这样对数据库并不友好。</p><p>我们应尽量避免单个事务过大、过长、过于复杂，建议将单个事务中多条SQL操作,分解、拆分，或者不放在同一个事务里，让每个事务的粒度尽可能小，这样可以尽量lock较少的资源，减少lock阻塞 、dead lock的产生</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">#sesseion1把所有数据都更新而不提交，一下子锁了2000千万条记录</span></span>
...
<span class="line"><span style="color:#24292e;">CREATE INDEX</span></span></code></pre></div><p>DB object包含: tablespace，database, schema, table, column, view, index, sequence, function, trigger等。 (1) 对象按类别带上标识，表tab,索引idx，视图v，函数fun等。 (2) 不建议以dba_、pgxl_、pg_、pgxc_开头，避免与系统对象、dba人员使用对象混淆。 (3) 建议使用小写字母、数字、下划线的组合。</p><p>(4) 临时中间表或临时备份表建议加上日期, 如tab_tmp_2020_10_12、tab_bak_2020_10_12；</p>`,45),o=[l];function t(c,i,r,d,_,y){return a(),n("div",null,o)}const m=s(p,[["render",t]]);export{b as __pageData,m as default};
