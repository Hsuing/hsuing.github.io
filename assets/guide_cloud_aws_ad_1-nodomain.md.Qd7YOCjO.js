import{_ as s,o as n,c as a,R as e}from"./chunks/framework.PZ77rLUR.js";const h=JSON.parse('{"title":"一、搭建无域","description":"","frontmatter":{},"headers":[],"relativePath":"guide/cloud/aws/ad/1-nodomain.md","filePath":"guide/cloud/aws/ad/1-nodomain.md","lastUpdated":1701330715000}'),l={name:"guide/cloud/aws/ad/1-nodomain.md"},p=e(`<ul><li><p>在aws上搭建ad无域环境</p></li><li><p>windows server 2016 可以搭建无域环境</p></li><li><p>关闭防火墙</p></li></ul><p>注意事项：</p><p>1，两个节点的Windos Server 2016 都已Administrator账户运行，并且两台服务器的Administrator密码相同。</p><p>2，两个节点的SQL Server 2016 服务启动账户都设置成Administrator</p><h1 id="一、搭建无域" tabindex="-1">一、搭建无域 <a class="header-anchor" href="#一、搭建无域" aria-label="Permalink to &quot;一、搭建无域&quot;">​</a></h1><blockquote><p>环境</p></blockquote><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">windows server 2016 base</span></span>
