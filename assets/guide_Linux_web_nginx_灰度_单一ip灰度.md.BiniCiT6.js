import{_ as s,c as n,o as a,R as e}from"./chunks/framework.CIzs38F0.js";const m=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"guide/Linux/web/nginx/灰度/单一ip灰度.md","filePath":"guide/Linux/web/nginx/灰度/单一ip灰度.md","lastUpdated":1701684699000}'),p={name:"guide/Linux/web/nginx/灰度/单一ip灰度.md"},l=e(`<h2 id="单一ip" tabindex="-1">单一ip <a class="header-anchor" href="#单一ip" aria-label="Permalink to &quot;单一ip&quot;">​</a></h2><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">upstream prod {</span></span>
...
<span class="line"><span style="color:#24292e;">        root   /usr/share/nginx/html;</span></span>
<span class="line"><span style="color:#24292e;">    }</span></span>
<span class="line"><span style="color:#24292e;">}</span></span></code></pre></div>`,6),o=[l];function c(r,t,i,y,d,_){return a(),n("div",null,o)}const x=s(p,[["render",c]]);export{m as __pageData,x as default};
