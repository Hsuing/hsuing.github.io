import{_ as s,c as a,o as e,R as n}from"./chunks/framework.CIzs38F0.js";const y=JSON.parse('{"title":"生成密码","description":"","frontmatter":{},"headers":[],"relativePath":"guide/Linux/web/nginx/17-httpUser.md","filePath":"guide/Linux/web/nginx/17-httpUser.md","lastUpdated":1701684699000}'),p={name:"guide/Linux/web/nginx/17-httpUser.md"},l=n(`<h1 id="生成密码" tabindex="-1">生成密码 <a class="header-anchor" href="#生成密码" aria-label="Permalink to &quot;生成密码&quot;">​</a></h1><h2 id="方式1" tabindex="-1">方式1 <a class="header-anchor" href="#方式1" aria-label="Permalink to &quot;方式1&quot;">​</a></h2><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">printf &quot;your_username:$(openssl passwd -crypt your_password)\\n&quot; &gt;&gt; /etc/nginx/wzy.log</span></span></code></pre><pre class="shiki github-light vp-code-light"><code><span class="line"><span style="color:#24292e;">printf &quot;your_username:$(openssl passwd -crypt your_password)\\n&quot; &gt;&gt; /etc/nginx/wzy.log</span></span></code></pre></div><p><strong>此方式不需要安装httpd-tools</strong></p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">location /</span></span>
...
<span class="line"><span style="color:#24292e;">htpasswd -cb pass.db user1 12345 //user1 并输入密码</span></span></code></pre></div>`,7),t=[l];function o(c,i,r,d,u,h){return e(),a("div",null,t)}const _=s(p,[["render",o]]);export{y as __pageData,_ as default};
