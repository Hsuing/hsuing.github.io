import{_ as s,o as a,c as e,R as n}from"./chunks/framework.byfcZK4E.js";const g=JSON.parse('{"title":"2. 源码安装 geth","description":"","frontmatter":{},"headers":[],"relativePath":"guide/Blockchain/geth/1-install.md","filePath":"guide/Blockchain/geth/1-install.md","lastUpdated":1701401252000}'),l={name:"guide/Blockchain/geth/1-install.md"},p=n(`<blockquote><p>机器配置</p></blockquote><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">高级配置</span></span>
...
<span class="line"><span style="color:#24292e;">SSD与aws速度相同</span></span></code></pre></div><div class="warning custom-block"><p class="custom-block-title">WARNING</p><p>注意：由于现在公网上eth的块有1Ｔ数据量</p></div><h2 id="_1-配置-go-语言运行环境" tabindex="-1">1. 配置 go 语言运行环境 <a class="header-anchor" href="#_1-配置-go-语言运行环境" aria-label="Permalink to &quot;1. 配置 go 语言运行环境&quot;">​</a></h2><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">https://golang.org/dl/</span></span>
<span class="line"><span style="color:#e1e4e8;"></span></span>
...
<span class="line"><span style="color:#24292e;"></span></span>
<span class="line"><span style="color:#24292e;">PATH=&quot;/usr/local/go/bin:/usr/local/go-ethereum/build/bin:$PATH&quot;</span></span></code></pre></div><h2 id="_4-启动" tabindex="-1">4.启动 <a class="header-anchor" href="#_4-启动" aria-label="Permalink to &quot;4.启动&quot;">​</a></h2><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">mkdir /data/coin</span></span>
...
<span class="line"><span style="color:#24292e;">    geth.ipc=, 启动时产生一个文件</span></span></code></pre></div><h2 id="_5-关闭" tabindex="-1">5.关闭 <a class="header-anchor" href="#_5-关闭" aria-label="Permalink to &quot;5.关闭&quot;">​</a></h2><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">#!/bin/sh</span></span>
...
<span class="line"><span style="color:#24292e;">kill -INT $pid</span></span></code></pre></div><blockquote><p>kill -INT $pid将“中断”信号发送到具有进程ID的进程pid。然而，该过程可以决定忽略该信号，或者在退出和/或忽略它之前捕获信号并做某事</p></blockquote><blockquote><p>kill -9 $pid发送无法捕获或忽略的“kill”信号。该过程将被强制关闭，不会通知该过程，也没有机会进行任何清理</p></blockquote><h2 id="_6-进入节点-javascript-终端" tabindex="-1">6.进入节点 javascript 终端 <a class="header-anchor" href="#_6-进入节点-javascript-终端" aria-label="Permalink to &quot;6.进入节点 javascript 终端&quot;">​</a></h2><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">[root@eth eth]# ./geth attach /data/coin/eth/geth.ipc </span></span>
...
<span class="line"></span>
<span class="line"><span style="color:#6A737D;">#线上</span></span>
<span class="line"><span style="color:#6F42C1;">nohup</span><span style="color:#24292E;"> </span><span style="color:#032F62;">/data/apps/snapeth/geth</span><span style="color:#24292E;"> </span><span style="color:#005CC5;">--authrpc.jwtsecret</span><span style="color:#24292E;"> </span><span style="color:#032F62;">/data/apps/prysm/jwt.hex</span><span style="color:#24292E;"> </span><span style="color:#005CC5;">--syncmode</span><span style="color:#24292E;"> </span><span style="color:#032F62;">snap</span><span style="color:#24292E;"> </span><span style="color:#005CC5;">--allow-insecure-unlock</span><span style="color:#24292E;"> </span><span style="color:#005CC5;">--authrpc.port</span><span style="color:#24292E;"> </span><span style="color:#005CC5;">8551</span><span style="color:#24292E;"> </span><span style="color:#005CC5;">--port</span><span style="color:#24292E;"> </span><span style="color:#005CC5;">30303</span><span style="color:#24292E;"> </span><span style="color:#005CC5;">--http</span><span style="color:#24292E;"> </span><span style="color:#005CC5;">--http.port</span><span style="color:#24292E;"> </span><span style="color:#005CC5;">8546</span><span style="color:#24292E;"> </span><span style="color:#005CC5;">--http.port</span><span style="color:#24292E;"> </span><span style="color:#005CC5;">8545</span><span style="color:#24292E;"> </span><span style="color:#005CC5;">--http.api</span><span style="color:#24292E;"> </span><span style="color:#032F62;">web3,db,eth,net,personal</span><span style="color:#24292E;"> </span><span style="color:#005CC5;">--http.addr=172.31.34.215</span><span style="color:#24292E;"> </span><span style="color:#005CC5;">--datadir</span><span style="color:#24292E;"> </span><span style="color:#032F62;">/data/coin/snapETH</span><span style="color:#24292E;"> </span><span style="color:#005CC5;">--maxpeers</span><span style="color:#24292E;"> </span><span style="color:#005CC5;">101</span><span style="color:#24292E;"> </span><span style="color:#005CC5;">--cache</span><span style="color:#24292E;"> </span><span style="color:#005CC5;">1024</span><span style="color:#24292E;"> </span><span style="color:#005CC5;">--rpc.allow-unprotected-txs</span><span style="color:#24292E;"> &amp;</span></span></code></pre></div><h1 id="_10-删除块" tabindex="-1">10.删除块 <a class="header-anchor" href="#_10-删除块" aria-label="Permalink to &quot;10.删除块&quot;">​</a></h1><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">[root@eth_new snapeth]# tree -L 1 /data/coin/snapETH/geth</span></span>
<span class="line"><span style="color:#e1e4e8;">/data/coin/snapETH/geth</span></span>
<span class="line"><span style="color:#e1e4e8;">├── chaindata</span></span>
<span class="line"><span style="color:#e1e4e8;">    |</span></span>
<span class="line"><span style="color:#e1e4e8;">    ancient</span></span>
<span class="line"><span style="color:#e1e4e8;">├── ethash</span></span>
<span class="line"><span style="color:#e1e4e8;">├── jwtsecret</span></span>
<span class="line"><span style="color:#e1e4e8;">├── LOCK</span></span>
<span class="line"><span style="color:#e1e4e8;">├── nodekey</span></span>
<span class="line"><span style="color:#e1e4e8;">├── nodes</span></span>
<span class="line"><span style="color:#e1e4e8;">└── transactions.rlp</span></span></code></pre><pre class="shiki github-light vp-code-light"><code><span class="line"><span style="color:#24292e;">[root@eth_new snapeth]# tree -L 1 /data/coin/snapETH/geth</span></span>
<span class="line"><span style="color:#24292e;">/data/coin/snapETH/geth</span></span>
<span class="line"><span style="color:#24292e;">├── chaindata</span></span>
<span class="line"><span style="color:#24292e;">    |</span></span>
<span class="line"><span style="color:#24292e;">    ancient</span></span>
<span class="line"><span style="color:#24292e;">├── ethash</span></span>
<span class="line"><span style="color:#24292e;">├── jwtsecret</span></span>
<span class="line"><span style="color:#24292e;">├── LOCK</span></span>
<span class="line"><span style="color:#24292e;">├── nodekey</span></span>
<span class="line"><span style="color:#24292e;">├── nodes</span></span>
<span class="line"><span style="color:#24292e;">└── transactions.rlp</span></span></code></pre></div><h2 id="removedb" tabindex="-1">removedb <a class="header-anchor" href="#removedb" aria-label="Permalink to &quot;removedb&quot;">​</a></h2><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">geth removedb</span></span>
<span class="line"><span style="color:#e1e4e8;"></span></span>
<span class="line"><span style="color:#e1e4e8;">#This is useful for deleting an old chain and sync’ing to a new one. It only affects data directories that can be re-created on synchronisation and does not touch the keystore</span></span></code></pre><pre class="shiki github-light vp-code-light"><code><span class="line"><span style="color:#24292e;">geth removedb</span></span>
<span class="line"><span style="color:#24292e;"></span></span>
<span class="line"><span style="color:#24292e;">#This is useful for deleting an old chain and sync’ing to a new one. It only affects data directories that can be re-created on synchronisation and does not touch the keystore</span></span></code></pre></div><h2 id="rmdb" tabindex="-1">rmdb <a class="header-anchor" href="#rmdb" aria-label="Permalink to &quot;rmdb&quot;">​</a></h2><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">#删除chaindata即可，排除ancient</span></span>
<span class="line"><span style="color:#e1e4e8;">rsync --delete-before -d test/ hantest/</span></span></code></pre><pre class="shiki github-light vp-code-light"><code><span class="line"><span style="color:#24292e;">#删除chaindata即可，排除ancient</span></span>
<span class="line"><span style="color:#24292e;">rsync --delete-before -d test/ hantest/</span></span></code></pre></div><h1 id="手册参考地址" tabindex="-1">手册参考地址： <a class="header-anchor" href="#手册参考地址" aria-label="Permalink to &quot;手册参考地址：&quot;">​</a></h1><p><a href="https://www.netkiller.cn/blockchain/ethereum/geth/index.html" target="_blank" rel="noreferrer">https://www.netkiller.cn/blockchain/ethereum/geth/index.html</a></p><p><a href="https://ethgasstation.info/index.php" target="_blank" rel="noreferrer">ETH手续费价格查询</a></p><p><a href="https://github.com/ethereum/go-ethereum/wiki/Management-APIs" target="_blank" rel="noreferrer">官方github-API</a></p><p><a href="https://github.com/ethereum/wiki/wiki/JSON-RPC#eth_getbalance" target="_blank" rel="noreferrer">官方github-RPC</a></p><p><a href="http://cw.hubwiz.com/card/c/ethereum-json-rpc-api/1/3/22/" target="_blank" rel="noreferrer">汇智网-RPC-中文</a></p><p><a href="https://ethereum.gitbooks.io/frontier-guide/content/rpc.html#eth_gettransactionreceipt" target="_blank" rel="noreferrer">GitBook-RPC-英文</a></p>`,85),o=[p];function t(c,r,i,d,u,y){return a(),e("div",null,o)}const m=s(l,[["render",t]]);export{g as __pageData,m as default};
