import{_ as s,c as a,o as n,R as l}from"./chunks/framework.CIzs38F0.js";const m=JSON.parse('{"title":"开启 PostgreSQL 日志","description":"","frontmatter":{},"headers":[],"relativePath":"guide/Database/pgSql/base/3-log.md","filePath":"guide/Database/pgSql/base/3-log.md","lastUpdated":1711694824000}'),e={name:"guide/Database/pgSql/base/3-log.md"},p=l(`<div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;"># 启动日志收集， 这是一个后台进程，抓取发送到stderr的日志消息，并会将他们重定向到日志文件。</span></span>
