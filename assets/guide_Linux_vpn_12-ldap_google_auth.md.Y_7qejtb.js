import{_ as s,c as n,o as a,R as e}from"./chunks/framework.CIzs38F0.js";const g=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"guide/Linux/vpn/12-ldap_google_auth.md","filePath":"guide/Linux/vpn/12-ldap_google_auth.md","lastUpdated":1701928035000}'),p={name:"guide/Linux/vpn/12-ldap_google_auth.md"},l=e(`<p>以下都是在openvpn server端执行</p><h2 id="_1-server端配置" tabindex="-1">1.server端配置 <a class="header-anchor" href="#_1-server端配置" aria-label="Permalink to &quot;1.server端配置&quot;">​</a></h2><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">port 1194</span></span>
...
<span class="line"><span style="color:#24292e;">[jmumr@idm ~]$ logout</span></span></code></pre></div>`,26),o=[l];function c(t,r,i,d,y,u){return a(),n("div",null,o)}const m=s(p,[["render",c]]);export{g as __pageData,m as default};
