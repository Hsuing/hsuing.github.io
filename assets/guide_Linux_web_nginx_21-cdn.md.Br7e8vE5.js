import{_ as s,c as a,o as e,R as n}from"./chunks/framework.CIzs38F0.js";const p="/assets/image-20220323175628354.DsN-WZhi.png",l="/assets/1029177661.CA5Q152t.png",E=JSON.parse('{"title":"源站IP泄漏","description":"","frontmatter":{},"headers":[],"relativePath":"guide/Linux/web/nginx/21-cdn.md","filePath":"guide/Linux/web/nginx/21-cdn.md","lastUpdated":1701684699000}'),o={name:"guide/Linux/web/nginx/21-cdn.md"},c=n(`<p>当我们源站只在一个地区，但 边缘用户/CDN 直接回源因为公网不确定因素导致回源不稳定的时候，这时我们需要考虑如何让 “源站” 更贴近用户；</p><p>于是可以在异地设置一个边缘节点，然后通过专线或相较公网更稳定的方式回源，于是有了如下设置</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">upstream source_server {</span></span>
...
<span class="line"><span style="color:#24292e;">}</span></span></code></pre></div>`,38),t=[c];function r(i,y,d,_,h,S){return e(),a("div",null,t)}const C=s(o,[["render",r]]);export{E as __pageData,C as default};
