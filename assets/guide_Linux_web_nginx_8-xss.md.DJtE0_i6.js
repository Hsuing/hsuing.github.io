import{_ as e,D as n,c as a,I as t,w as l,R as p,o,a as c}from"./chunks/framework.CIzs38F0.js";const q=JSON.parse('{"title":"1,点击劫持","description":"","frontmatter":{},"headers":[],"relativePath":"guide/Linux/web/nginx/8-xss.md","filePath":"guide/Linux/web/nginx/8-xss.md","lastUpdated":1701684699000}'),r={name:"guide/Linux/web/nginx/8-xss.md"},i=p(`<h1 id="_1-点击劫持" tabindex="-1">1,点击劫持 <a class="header-anchor" href="#_1-点击劫持" aria-label="Permalink to &quot;1,点击劫持&quot;">​</a></h1><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;"># 点击劫持（ClickJacking）是一种视觉上的欺骗手段。大概有两种方式，</span></span>
