import{_ as s,o as n,c as a,R as e}from"./chunks/framework.byfcZK4E.js";const h=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"guide/Linux/web/nginx/modules/lua.md","filePath":"guide/Linux/web/nginx/modules/lua.md","lastUpdated":1701684699000}'),p={name:"guide/Linux/web/nginx/modules/lua.md"},l=e(`<div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">location = /admin.php {</span></span>
