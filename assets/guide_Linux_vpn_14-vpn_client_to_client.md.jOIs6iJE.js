import{_ as s,o as n,c as a,R as e}from"./chunks/framework.byfcZK4E.js";const v=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"guide/Linux/vpn/14-vpn_client_to_client.md","filePath":"guide/Linux/vpn/14-vpn_client_to_client.md","lastUpdated":1701595065000}'),p={name:"guide/Linux/vpn/14-vpn_client_to_client.md"},l=e(`<ul><li>阿里云环境</li><li>centos7</li><li>openvpn2.4</li></ul><h2 id="_1-server端配置" tabindex="-1">1.server端配置 <a class="header-anchor" href="#_1-server端配置" aria-label="Permalink to &quot;1.server端配置&quot;">​</a></h2><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">port 10020</span></span>
