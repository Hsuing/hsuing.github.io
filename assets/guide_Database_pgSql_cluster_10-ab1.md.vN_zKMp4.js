import{_ as s,c as n,o as a,R as e}from"./chunks/framework.CIzs38F0.js";const m=JSON.parse('{"title":"老式pg_basebackup 搭建流复制环境","description":"","frontmatter":{},"headers":[],"relativePath":"guide/Database/pgSql/cluster/10-ab1.md","filePath":"guide/Database/pgSql/cluster/10-ab1.md","lastUpdated":1711706974000}'),l={name:"guide/Database/pgSql/cluster/10-ab1.md"},p=e(`<h1 id="老式pg-basebackup-搭建流复制环境" tabindex="-1">老式pg_basebackup 搭建流复制环境 <a class="header-anchor" href="#老式pg-basebackup-搭建流复制环境" aria-label="Permalink to &quot;老式pg_basebackup 搭建流复制环境&quot;">​</a></h1><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark has-diff vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">--异步流复制 ，事务提交时不需要等待备库接收并写入wal日志便返回成功。</span></span>
...
<span class="line"><span style="color:#24292e;">select pg_wal_lsn_diff(&#39;&#39;,&#39;&#39;);</span></span></code></pre></div>`,2),o=[p];function c(t,r,i,y,_,d){return a(),n("div",null,o)}const u=s(l,[["render",c]]);export{m as __pageData,u as default};
