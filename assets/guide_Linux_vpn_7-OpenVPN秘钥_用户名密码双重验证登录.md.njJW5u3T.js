import{_ as s,o as n,c as e,R as a}from"./chunks/framework.byfcZK4E.js";const v=JSON.parse('{"title":"1.配置openvpn使用  秘钥+用户名密码 验证登录","description":"","frontmatter":{},"headers":[],"relativePath":"guide/Linux/vpn/7-OpenVPN秘钥+用户名密码双重验证登录.md","filePath":"guide/Linux/vpn/7-OpenVPN秘钥+用户名密码双重验证登录.md","lastUpdated":1701595065000}'),p={name:"guide/Linux/vpn/7-OpenVPN秘钥+用户名密码双重验证登录.md"},l=a(`<h1 id="_1-配置openvpn使用-秘钥-用户名密码-验证登录" tabindex="-1">1.配置openvpn使用 秘钥+用户名密码 验证登录 <a class="header-anchor" href="#_1-配置openvpn使用-秘钥-用户名密码-验证登录" aria-label="Permalink to &quot;1.配置openvpn使用  秘钥+用户名密码 验证登录&quot;">​</a></h1><h2 id="_1-修改server端配置文件-添加以下三行代码。" tabindex="-1">1.修改Server端配置文件，添加以下三行代码。 <a class="header-anchor" href="#_1-修改server端配置文件-添加以下三行代码。" aria-label="Permalink to &quot;1.修改Server端配置文件，添加以下三行代码。&quot;">​</a></h2><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">auth-user-pass-verify /etc/openvpn/checkpsw.sh via-env</span></span>
