import{_ as s,c as n,o as a,R as p}from"./chunks/framework.CIzs38F0.js";const m=JSON.parse('{"title":"1.golang方法","description":"","frontmatter":{},"headers":[],"relativePath":"guide/go/26-Go方法.md","filePath":"guide/go/26-Go方法.md","lastUpdated":1701229860000}'),l={name:"guide/go/26-Go方法.md"},o=p(`<h1 id="_1-golang方法" tabindex="-1">1.golang方法 <a class="header-anchor" href="#_1-golang方法" aria-label="Permalink to &quot;1.golang方法&quot;">​</a></h1><p>go语言没有面向对象的特征，也没有类对象的概念。但是，可以使用结构体来模拟这些特征，我们都知道面向对象里面有类方法等概念。我们可以声明一些方法，属于某个结构体。</p><h2 id="_1-1go语言放的语法" tabindex="-1">1.1go语言放的语法 <a class="header-anchor" href="#_1-1go语言放的语法" aria-label="Permalink to &quot;1.1go语言放的语法&quot;">​</a></h2><p>Go中的方法，是一种特殊的函数，定义于struct之上（与struct关联、绑定），被称为struct的接受者（receiver）。</p><p>通俗的讲，方法就是有接受者的函数。</p><ul><li>语法格式：</li></ul><div class="language-go vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">go</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#F97583;">type</span><span style="color:#E1E4E8;"> </span><span style="color:#B392F0;">mytype</span><span style="color:#E1E4E8;"> </span><span style="color:#F97583;">struct</span><span style="color:#E1E4E8;">{}</span></span>
...
<span class="line"><span style="color:#24292E;">	fmt.</span><span style="color:#005CC5;">Printf</span><span style="color:#24292E;">(</span><span style="color:#032F62;">&quot;p2: </span><span style="color:#005CC5;">%v\\n</span><span style="color:#032F62;">&quot;</span><span style="color:#24292E;">, </span><span style="color:#D73A49;">*</span><span style="color:#24292E;">p2)</span></span>
<span class="line"><span style="color:#24292E;">}</span></span></code></pre></div>`,29),e=[o];function t(c,r,E,y,i,F){return a(),n("div",null,e)}const C=s(l,[["render",t]]);export{m as __pageData,C as default};
