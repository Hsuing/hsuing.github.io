...
<span class="line"><span style="color:#24292e;">rabbitmq-plugins enable rabbitmq_federation_management</span></span></code></pre></div><blockquote><p>安装好rabbitmq_shovel和rabbitmq_shovel_management两个插件之后，就可以在rabbitmq的管理页面查看到这两个插件，首先创建一个shovel.填入的信息主要包括要同步的vhost名称，起一个名字，来源mq服务器地址和队列，目标mq服务器地址和队列，其中要有对vhost授权的账户和密码。目标MQ集群要提前创建好vhost,配置的授权账户和密码，包括队列等</p><p>有一个插件Federation，这个插件一般用于实时同步消息的</p></blockquote><ol start="8"><li></li></ol>`,148),g=[m];function q(v,_,k,x,f,w){return e(),n("div",null,g)}const P=a(y,[["render",q]]);export{C as __pageData,P as default};
