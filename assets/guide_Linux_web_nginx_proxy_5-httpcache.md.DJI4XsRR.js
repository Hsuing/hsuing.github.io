import{_ as s,c as a,o as e,R as n}from"./chunks/framework.CIzs38F0.js";const p="/assets/httpcache.DMUDa1Gb.png",_=JSON.parse('{"title":"1. HTTP缓存控制/浏览器缓存控制","description":"","frontmatter":{},"headers":[],"relativePath":"guide/Linux/web/nginx/proxy/5-httpcache.md","filePath":"guide/Linux/web/nginx/proxy/5-httpcache.md","lastUpdated":1701684699000}'),l={name:"guide/Linux/web/nginx/proxy/5-httpcache.md"},o=n('<h1 id="_1-http缓存控制-浏览器缓存控制" tabindex="-1">1. HTTP缓存控制/浏览器缓存控制 <a class="header-anchor" href="#_1-http缓存控制-浏览器缓存控制" aria-label="Permalink to &quot;1. HTTP缓存控制/浏览器缓存控制&quot;">​</a></h1><p><img src="'+p+`" alt="HTTP缓存控制/浏览器缓存控制"></p><blockquote><p>[!TIP]</p></blockquote><blockquote><p>浏览器的缓存，主要分为两种</p></blockquote><blockquote><p>强缓存 200 (from memory cache)和200 (from disk cache)</p></blockquote><blockquote><p>协商缓存 304 (Not Modified)</p></blockquote><h2 id="_1-2-强缓存" tabindex="-1">1.2 强缓存 <a class="header-anchor" href="#_1-2-强缓存" aria-label="Permalink to &quot;1.2 强缓存&quot;">​</a></h2><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">如果启用了强缓存，请求资源时不会向服务器发送请求，直接从缓存中读取资源，在chrome控制台的network中看到请求返回的200状态码，并在状态码的后面跟着from disk cache 或者from memory cache关键字。两者的差别在于获取缓存的位置不一样。</span></span>
...
<span class="line"><span style="color:#24292e;">	}</span></span></code></pre></div>`,29),t=[o];function c(i,r,h,d,y,g){return e(),a("div",null,t)}const u=s(l,[["render",c]]);export{_ as __pageData,u as default};
