import{_ as s,c as n,o as e,R as a}from"./chunks/framework.CIzs38F0.js";const A=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"guide/Linux/web/nginx/23-FAQ.md","filePath":"guide/Linux/web/nginx/23-FAQ.md","lastUpdated":1701684699000}'),p={name:"guide/Linux/web/nginx/23-FAQ.md"},l=a(`<ul><li>nginx部署ssl证书出现[emerg] PEM_read_bio_X509_AUX failed的解决办法</li></ul><p>nginx -t</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">nginx: [emerg] PEM_read_bio_X509_AUX(&quot;xxxxxxxx.pem&quot;) failed (SSL: error:0906D066:PEM routines:PEM_read_bio:bad end line)</span></span>
...
<span class="line"><span style="color:#24292e;">ngx_null_string, /* 499, client has closed connection */</span></span></code></pre></div>`,8),o=[l];function t(c,i,r,g,d,_){return e(),n("div",null,o)}const x=s(p,[["render",t]]);export{A as __pageData,x as default};
