import{_ as s,c as a,o as n,R as e}from"./chunks/framework.CIzs38F0.js";const h=JSON.parse('{"title":"1.temporary","description":"","frontmatter":{},"headers":[],"relativePath":"guide/container/faq/index.md","filePath":"guide/container/faq/index.md","lastUpdated":1710238820000}'),p={name:"guide/container/faq/index.md"},l=e(`<h1 id="_1-temporary" tabindex="-1">1.temporary <a class="header-anchor" href="#_1-temporary" aria-label="Permalink to &quot;1.temporary&quot;">​</a></h1><p>现象：</p><p>docker build “temporary failure resolving deb.debian.org”</p><p>解决：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">修改docker daemon配置文件</span></span>
...
<span class="line"><span style="color:#032F62;">ENTRYPOINT  chmod +x Activity.Core &amp;&amp; /vela/app/Activity.Core</span></span></code></pre></div>`,7),t=[l];function o(c,i,r,d,u,y){return n(),a("div",null,t)}const g=s(p,[["render",o]]);export{h as __pageData,g as default};
