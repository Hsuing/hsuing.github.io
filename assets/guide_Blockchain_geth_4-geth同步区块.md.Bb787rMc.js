import{_ as e,D as a,c as n,I as p,w as l,R as t,o,a as c}from"./chunks/framework.CIzs38F0.js";const b=JSON.parse('{"title":"1.关闭 A服务器 上 的 geth","description":"","frontmatter":{},"headers":[],"relativePath":"guide/Blockchain/geth/4-geth同步区块.md","filePath":"guide/Blockchain/geth/4-geth同步区块.md","lastUpdated":1701401252000}'),i={name:"guide/Blockchain/geth/4-geth同步区块.md"},r=t(`<p>核心思路 : 从原有的(或者从别人那里) 拷贝数据到自己的服务器</p><blockquote><p>在 geth 的控制台调用 eth.syncing 发现 currentBlock 一直低于highestBlock</p></blockquote><p>环境：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">服务器 A: 已经同步好区块的服务器</span></span>
...
<span class="line"><span style="color:#24292e;">NFO [11-29|07:56:16.208] Started P2P networking  self=&quot;enode://xxxxx@0.0.0.0:30303?discport=0&quot;</span></span></code></pre></div>`,16);function d(h,g,y,u,x,k){const s=a("center");return o(),n("div",null,[p(s,null,{default:l(()=>[c("geth 同步区块一直落后的解决方案")]),_:1}),r])}const m=e(i,[["render",d]]);export{b as __pageData,m as default};
