import{_ as s,c as n,o as e,R as a}from"./chunks/framework.CIzs38F0.js";const g=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"guide/Linux/vpn/5吊销证书.md","filePath":"guide/Linux/vpn/5吊销证书.md","lastUpdated":1701595065000}'),p={name:"guide/Linux/vpn/5吊销证书.md"},l=a(`<div class="danger custom-block"><p class="custom-block-title">❌ 注意</p><p>吊销证书</p></div><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">[root@openvpn ~]# cd /etc/openvpn/easy-rsa/</span></span>
...
<span class="line"><span style="color:#24292e;">[root@openvpn openvpn]# find . -type f -name &quot;dalin.*&quot; | xargs rm</span></span></code></pre></div>`,7),o=[l];function c(t,r,i,y,d,u){return e(),n("div",null,o)}const f=s(p,[["render",c]]);export{g as __pageData,f as default};
