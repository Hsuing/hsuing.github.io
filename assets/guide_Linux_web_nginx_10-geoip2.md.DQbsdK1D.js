import{_ as s,c as n,o as a,R as l}from"./chunks/framework.CIzs38F0.js";const _=JSON.parse('{"title":"一、安装","description":"","frontmatter":{},"headers":[],"relativePath":"guide/Linux/web/nginx/10-geoip2.md","filePath":"guide/Linux/web/nginx/10-geoip2.md","lastUpdated":1701684699000}'),p={name:"guide/Linux/web/nginx/10-geoip2.md"},e=l(`<h1 id="一、安装" tabindex="-1">一、安装 <a class="header-anchor" href="#一、安装" aria-label="Permalink to &quot;一、安装&quot;">​</a></h1><ul><li>参考</li></ul><p><a href="https://www.maxmind.com/en/geoip2-databases" target="_blank" rel="noreferrer">https://www.maxmind.com/en/geoip2-databases</a></p><p><a href="https://docs.nginx.com/nginx/admin-guide/dynamic-modules/geoip2/" target="_blank" rel="noreferrer">https://docs.nginx.com/nginx/admin-guide/dynamic-modules/geoip2/</a></p><p><a href="https://www.fengbohello.top/archives/ip2location-geolite2" target="_blank" rel="noreferrer">https://www.fengbohello.top/archives/ip2location-geolite2</a></p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">#!/bin/bash</span></span>
...
<span class="line"><span style="color:#e1e4e8;">hxopensource1990@gmail.com</span></span>
<span class="line"><span style="color:#e1e4e8;">ar3*hK9Tp9shu_N</span></span>
<span class="line"><span style="color:#e1e4e8;"></span></span>
<span class="line"><span style="color:#e1e4e8;">https://www.maxmind.com/en/accounts/590775/geoip/downloads</span></span></code></pre><pre class="shiki github-light vp-code-light"><code><span class="line"><span style="color:#24292e;">#免费库</span></span>
<span class="line"><span style="color:#24292e;">hxopensource1990@gmail.com</span></span>
<span class="line"><span style="color:#24292e;">ar3*hK9Tp9shu_N</span></span>
<span class="line"><span style="color:#24292e;"></span></span>
<span class="line"><span style="color:#24292e;">https://www.maxmind.com/en/accounts/590775/geoip/downloads</span></span></code></pre></div><ul><li>另一种配置</li></ul><div class="language-bash vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"></span>
...
<span class="line"><span style="color:#24292e;"> if ($geoip2_data_country_code != CN) {</span></span>
<span class="line"><span style="color:#24292e;">    return 444;</span></span>
<span class="line"><span style="color:#24292e;"> }</span></span></code></pre></div><ul><li>获取用户ip属于区域</li></ul><div class="language-bash vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#B392F0;">mmdblookup</span><span style="color:#E1E4E8;"> </span><span style="color:#79B8FF;">--file</span><span style="color:#E1E4E8;"> </span><span style="color:#9ECBFF;">GeoLite2-City.mmdb</span><span style="color:#E1E4E8;"> </span><span style="color:#79B8FF;">--ip</span><span style="color:#E1E4E8;"> </span><span style="color:#9ECBFF;">x.x.x.x</span></span>
<span class="line"></span>
<span class="line"><span style="color:#E1E4E8;">{</span></span>
...
<span class="line"><span style="color:#24292E;">          }</span></span>
<span class="line"><span style="color:#24292E;">      }</span></span>
<span class="line"><span style="color:#24292E;">  }</span></span></code></pre></div>`,25),o=[e];function t(c,r,i,y,E,u){return a(),n("div",null,o)}const g=s(p,[["render",t]]);export{_ as __pageData,g as default};
